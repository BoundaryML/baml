...
export function ReviewSite({ outputs, input }: ReviewSiteProps) {
  return (
    <Task
      id="review-site"
      output={outputs.bttSite}
      agent={codexSolBuilder}
      needs={{ pr: "create-draft-pr", reviews: "commit-reviews", plan: "synthesize-plan" }}
      deps={{ pr: outputs.bttPr, reviews: outputs.bttCommitReviews, plan: outputs.bttPlan }}
