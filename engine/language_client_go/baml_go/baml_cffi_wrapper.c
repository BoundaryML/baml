...
DEFINE_WRAPPER_FUNCTIONS(const void *, CallCollectorFunction, (const void *object, const char *object_type, const char *function_name, const char *encoded_args, uintptr_t length), (object, object_type, function_name, encoded_args, length), NULL)
