...
export class BamlSyncClient {
  ...
  MakeClassWithBlockDone(__baml_options__?: BamlCallOptions): types.ClassWithBlockDone {
    try {
  ...
  MakeClassWithExternalDone(__baml_options__?: BamlCallOptions): types.ClassWithoutDone {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector
        ? Array.isArray(options.collector)
  ...
  MakeSemanticContainer(__baml_options__?: BamlCallOptions): types.SemanticContainer {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector
        ? Array.isArray(options.collector)
