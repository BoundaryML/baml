    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.TestKitchenSink(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.KitchenSink
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.TestRecursiveComplexity(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Node
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.TestUltraComplex(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.UltraComplex
            } catch (error) {
            throw toBamlError(error);
            }
            }
