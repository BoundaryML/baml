...
export class BamlSyncClient {
  ...
  ConsumeSimpleClass(item: types.SimpleClass, __baml_options__?: BamlCallOptions): types.SimpleClass {
    try {
  ...
  MakeSimpleClass(__baml_options__?: BamlCallOptions): types.SimpleClass {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector
        ? Array.isArray(options.collector)
