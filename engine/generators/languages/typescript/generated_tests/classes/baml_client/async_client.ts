...
import type { Check, Checked, RecursivePartialNull as MovedRecursivePartialNull, SimpleClass } from './types'
...
export class BamlAsyncClient {
  ...
  async ConsumeSimpleClass(item: types.SimpleClass, __baml_options__?: BamlCallOptions): Promise<types.SimpleClass> {
    try {
  ...
  async MakeSimpleClass(__baml_options__?: BamlCallOptions): Promise<types.SimpleClass> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector
        ? Array.isArray(options.collector)
...
class BamlStreamClient {
  ...
  MakeSimpleClass(__baml_options__?: {
    tb?: TypeBuilder
    clientRegistry?: ClientRegistry
    collector?: Collector | Collector[]
    env?: Record<string, string | undefined>
