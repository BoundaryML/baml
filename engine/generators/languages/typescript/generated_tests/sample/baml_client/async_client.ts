    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.Bar(
          x,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Example | types.Example2
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.Foo(
          x,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Example2 | types.Example
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for Bar", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for Foo", error);
              }
              }
              };
              }
