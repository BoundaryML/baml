...
export class BamlSyncClient {
  ...
  ConsumeTestEnum(input: types.TestEnum, __baml_options__?: BamlCallOptions): types.TestEnum {
    try {
  ...
  FnTestAliasedEnumOutput(input: string, __baml_options__?: BamlCallOptions): types.TestEnum {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector
        ? Array.isArray(options.collector)
