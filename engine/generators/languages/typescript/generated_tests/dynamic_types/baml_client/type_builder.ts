...
export default class TypeBuilder {
    ...
    Address: ClassViewer<'Address', "street" | "city" | "country">;
    
    Article: ClassBuilder<'Article', "title" | "category" | "author" | "status">;
    ...
    Priority: EnumBuilder<'Priority', "High" | "Medium" | "Low">;
    ...
    constructor() {
        ...
        this.Article = this.tb.classBuilder("Article", [
        ...
        this.Category = this.tb.enumBuilder("Category", [
          "Technology","Science","Arts",
        ]);
        
        this.Priority = this.tb.enumBuilder("Priority", [
          "High","Medium","Low",
        ]);
