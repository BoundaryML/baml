...
pub fn builtin_schemas() -> IndexMap<TypeName, TypeOpenApi> {
    IndexMap::from_iter(vec![
        (TypeName("BamlImage".to_string()), TypeOpenApi::Union {
            one_of: vec![
                TypeOpenApi::Inline {
        ...
        (TypeName("BamlAudio".to_string()), TypeOpenApi::Union {
            one_of: vec![
                TypeOpenApi::Inline {
                    r#type: TypePrimitive::Object {
                        properties: IndexMap::from_iter(vec![
        ...
        (TypeName("BamlOptions".to_string()), TypeOpenApi::Inline {
            r#type: TypePrimitive::Object {
                properties: IndexMap::from_iter(vec![(
            ...
            TypeOpenApi::Inline {
                r#type: TypePrimitive::Object {
                    properties: IndexMap::from_iter(vec![
                        ...
                        ("options".to_string(), TypeOpenApi::Inline {
                            r#type: TypePrimitive::Object {
        ...
        (TypeName("Check".to_string()), TypeOpenApi::Inline {
            r#type: TypePrimitive::Object {
                properties: IndexMap::from_iter(vec![
                    ("name".to_string(), type_string()),
