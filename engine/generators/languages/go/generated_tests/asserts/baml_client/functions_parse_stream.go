...
/// Parse version of PersonTest (Takes in string and returns stream_types.Person)
func (*parse_stream) PersonTest(text string, opts ...CallOptionFunc) (stream_types.Person, error) {
