...
// Build HTTP request for ConsumeTestEnum (returns baml.HTTPRequest)
func (*build_request) ConsumeTestEnum(input types.TestEnum, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
