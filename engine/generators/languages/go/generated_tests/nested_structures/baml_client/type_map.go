...
var typeMap = map[string]reflect.Type{
	...
	"TYPES.string_dark__string_light":                                          reflect.TypeOf(types.Union2KdarkOrKlight{}),
	"TYPES.string_grid__string_list":                                           reflect.TypeOf(types.Union2KgridOrKlist{}),
	"TYPES.bool__int__string":                                                  reflect.TypeOf(types.Union3BoolOrIntOrString{}),
	"TYPES.string_daily__string_immediate__string_weekly":                      reflect.TypeOf(types.Union3KdailyOrKimmediateOrKweekly{}),
	"TYPES.string_done__string_in_progress__string_todo":                       reflect.TypeOf(types.Union3KdoneOrKin_progressOrKtodo{}),
	"TYPES.string_friends__string_private__string_public":                      reflect.TypeOf(types.Union3KfriendsOrKprivateOrKpublic{}),
	"TYPES.string_high__string_low__string_medium":                             reflect.TypeOf(types.Union3KhighOrKlowOrKmedium{}),
	"TYPES.string_active__string_cancelled__string_completed__string_planning": reflect.TypeOf(types.Union4KactiveOrKcancelledOrKcompletedOrKplanning{}),
	"TYPES.string_enterprise__string_large__string_medium__string_small":       reflect.TypeOf(types.Union4KenterpriseOrKlargeOrKmediumOrKsmall{}),
}
