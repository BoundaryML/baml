...
module BamlClient
  ...
  class BamlSyncClient
      ...
      ).returns(BamlClient::Types::SimpleClass)}
      def ConsumeSimpleClass(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("ConsumeSimpleClass may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "ConsumeSimpleClass", args: {
              item: item,
          })
          ...
          parsed.cast_to(BamlClient::Types::SimpleClass)
      end
      sig {params(
          varargs: T.untyped,
      ...
      def MakeSimpleClass(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("MakeSimpleClass may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "MakeSimpleClass", args: {
  ...
  class BamlStreamClient
      ...
      def ConsumeSimpleClass(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "ConsumeSimpleClass", args: {
              item: item,
          })
      ...
      def MakeSimpleClass(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "MakeSimpleClass", args: {
