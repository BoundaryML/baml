  ...
  class BamlSyncClient
      ...
      def ConsumeTestEnum(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("ConsumeTestEnum may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "ConsumeTestEnum", args: {
              input: input,
          })
  ...
  class BamlStreamClient
      ...
      def ConsumeTestEnum(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "ConsumeTestEnum", args: {
              input: input,
          })
