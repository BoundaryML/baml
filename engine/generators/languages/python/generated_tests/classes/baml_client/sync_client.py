...
class BamlStreamClient:
    ...
    def ConsumeSimpleClass(self, item: types.SimpleClass,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[typing.Optional["stream_types.SimpleClass"], types.SimpleClass]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ConsumeSimpleClass", args={
            "item": item,
        })
        return baml_py.BamlSyncStream[typing.Optional["stream_types.SimpleClass"], types.SimpleClass](
          result,
