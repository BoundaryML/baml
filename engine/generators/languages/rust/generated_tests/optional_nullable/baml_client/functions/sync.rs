...
impl BamlClient {
    ...
    baml_function!(TestAllNull(input: impl AsRef<str> + BamlEncode, ) -> types::NullableTypes);

    baml_function!(TestAllOptionalOmitted(input: impl AsRef<str> + BamlEncode, ) -> types::OptionalFields);

    baml_function!(TestMixedOptionalNullable(input: impl AsRef<str> + BamlEncode, ) -> types::MixedOptionalNullable);

    baml_function!(TestNullableTypes(input: impl AsRef<str> + BamlEncode, ) -> types::NullableTypes);

    baml_function!(TestOptionalFields(input: impl AsRef<str> + BamlEncode, ) -> types::OptionalFields);
}
