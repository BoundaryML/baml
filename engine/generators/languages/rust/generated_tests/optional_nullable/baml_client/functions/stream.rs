...
impl BamlStreamClient {
    ...
    baml_function_stream!(TestAllNull(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::NullableTypes, types::NullableTypes));

    baml_function_stream!(TestAllOptionalOmitted(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::OptionalFields, types::OptionalFields));

    baml_function_stream!(TestMixedOptionalNullable(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::MixedOptionalNullable, types::MixedOptionalNullable));

    baml_function_stream!(TestNullableTypes(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::NullableTypes, types::NullableTypes));

    baml_function_stream!(TestOptionalFields(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::OptionalFields, types::OptionalFields));
}
