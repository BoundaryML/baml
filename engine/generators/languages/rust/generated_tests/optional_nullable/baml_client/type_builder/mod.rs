...
impl TypeBuilder {
    ...
    /// Access the `ComplexOptional` class builder.
    pub fn ComplexOptional(&self) -> ComplexOptionalClassBuilder {
        ComplexOptionalClassBuilder::new(
            self.inner
                .get_class("ComplexOptional")
                .expect("class ComplexOptional is defined in schema"),
        )
    }

    /// Access the `MixedOptionalNullable` class builder.
    pub fn MixedOptionalNullable(&self) -> MixedOptionalNullableClassBuilder {
        MixedOptionalNullableClassBuilder::new(
            self.inner
                .get_class("MixedOptionalNullable")
                .expect("class MixedOptionalNullable is defined in schema"),
        )
    }

    /// Access the `NullableTypes` class builder.
    pub fn NullableTypes(&self) -> NullableTypesClassBuilder {
        NullableTypesClassBuilder::new(
            self.inner
                .get_class("NullableTypes")
                .expect("class NullableTypes is defined in schema"),
        )
    }

    /// Access the `OptionalData` class builder.
    pub fn OptionalData(&self) -> OptionalDataClassBuilder {
        OptionalDataClassBuilder::new(
            self.inner
                .get_class("OptionalData")
                .expect("class OptionalData is defined in schema"),
        )
    }

    /// Access the `OptionalFields` class builder.
    pub fn OptionalFields(&self) -> OptionalFieldsClassBuilder {
        OptionalFieldsClassBuilder::new(
            self.inner
                .get_class("OptionalFields")
                .expect("class OptionalFields is defined in schema"),
        )
    }

    /// Access the `OptionalItem` class builder.
    pub fn OptionalItem(&self) -> OptionalItemClassBuilder {
        OptionalItemClassBuilder::new(
            self.inner
                .get_class("OptionalItem")
                .expect("class OptionalItem is defined in schema"),
        )
    }

    /// Access the `OptionalValue` class builder.
    pub fn OptionalValue(&self) -> OptionalValueClassBuilder {
        OptionalValueClassBuilder::new(
            self.inner
                .get_class("OptionalValue")
                .expect("class OptionalValue is defined in schema"),
        )
    }
    ...
    /// Access the `UnionWithNull` class builder.
    pub fn UnionWithNull(&self) -> UnionWithNullClassBuilder {
        UnionWithNullClassBuilder::new(
            self.inner
                .get_class("UnionWithNull")
                .expect("class UnionWithNull is defined in schema"),
        )
    }
