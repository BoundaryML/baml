...
baml_function_sync!(TestComplexNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexNested, types::ComplexNested));

baml_function_sync!(TestDeeplyNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::DeeplyNested, types::DeeplyNested));

baml_function_sync!(TestRecursiveStructure(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::RecursiveStructure, types::RecursiveStructure));

baml_function_sync!(TestSimpleNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::SimpleNested, types::SimpleNested));
