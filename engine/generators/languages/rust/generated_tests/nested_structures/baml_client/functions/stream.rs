...
impl BamlStreamClient {
    ...
    baml_function_stream!(TestComplexNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexNested, types::ComplexNested));

    baml_function_stream!(TestDeeplyNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::DeeplyNested, types::DeeplyNested));

    baml_function_stream!(TestRecursiveStructure(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::RecursiveStructure, types::RecursiveStructure));

    baml_function_stream!(TestSimpleNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::SimpleNested, types::SimpleNested));
}
