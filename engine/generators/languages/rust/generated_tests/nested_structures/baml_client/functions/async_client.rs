...
baml_function_async!(TestComplexNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexNested, types::ComplexNested));

baml_function_async!(TestDeeplyNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::DeeplyNested, types::DeeplyNested));

baml_function_async!(TestRecursiveStructure(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::RecursiveStructure, types::RecursiveStructure));

baml_function_async!(TestSimpleNested(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::SimpleNested, types::SimpleNested));
...
pub struct BamlAsyncClient {
    ...
    pub TestComplexNested: TestComplexNested,

    pub TestDeeplyNested: TestDeeplyNested,

    pub TestRecursiveStructure: TestRecursiveStructure,

    pub TestSimpleNested: TestSimpleNested,
}
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            TestComplexNested: TestComplexNested::new(),

            TestDeeplyNested: TestDeeplyNested::new(),

            TestRecursiveStructure: TestRecursiveStructure::new(),

            TestSimpleNested: TestSimpleNested::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            TestDeeplyNested: TestDeeplyNested {
                options: options.clone(),
            },

            TestRecursiveStructure: TestRecursiveStructure {
                options: options.clone(),
            },
