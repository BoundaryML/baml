...
impl TypeBuilder {
    ...
    /// Access the `MediaAnalysisResult` class builder.
    pub fn MediaAnalysisResult(&self) -> MediaAnalysisResultClassBuilder {
        MediaAnalysisResultClassBuilder::new(
            self.inner
                .get_class("MediaAnalysisResult")
                .expect("class MediaAnalysisResult is defined in schema"),
        )
    }

    /// Access the `MediaArrayAnalysisResult` class builder.
    pub fn MediaArrayAnalysisResult(&self) -> MediaArrayAnalysisResultClassBuilder {
        MediaArrayAnalysisResultClassBuilder::new(
            self.inner
                .get_class("MediaArrayAnalysisResult")
                .expect("class MediaArrayAnalysisResult is defined in schema"),
        )
    }

    /// Access the `MediaMapAnalysisResult` class builder.
    pub fn MediaMapAnalysisResult(&self) -> MediaMapAnalysisResultClassBuilder {
        MediaMapAnalysisResultClassBuilder::new(
            self.inner
                .get_class("MediaMapAnalysisResult")
                .expect("class MediaMapAnalysisResult is defined in schema"),
        )
    }

    /// Access the `MixedMediaAnalysisResult` class builder.
    pub fn MixedMediaAnalysisResult(&self) -> MixedMediaAnalysisResultClassBuilder {
        MixedMediaAnalysisResultClassBuilder::new(
            self.inner
                .get_class("MixedMediaAnalysisResult")
                .expect("class MixedMediaAnalysisResult is defined in schema"),
        )
    }

    /// Access the `OptionalMediaAnalysisResult` class builder.
    pub fn OptionalMediaAnalysisResult(&self) -> OptionalMediaAnalysisResultClassBuilder {
        OptionalMediaAnalysisResultClassBuilder::new(
            self.inner
                .get_class("OptionalMediaAnalysisResult")
                .expect("class OptionalMediaAnalysisResult is defined in schema"),
        )
    }
