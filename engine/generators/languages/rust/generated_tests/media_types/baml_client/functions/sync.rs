...
impl BamlClient {
    ...
    baml_function!(TestMediaArrayInputs(imageArray: &[types::Image], textInput: impl AsRef<str> + BamlEncode, ) -> types::MediaArrayAnalysisResult);

    baml_function!(TestMediaInput(media: &types::Union4AudioOrImageOrPDFOrVideo, textInput: impl AsRef<str> + BamlEncode, ) -> types::MediaAnalysisResult);
}
