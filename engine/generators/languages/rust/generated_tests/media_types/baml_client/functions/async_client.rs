...
baml_function_async!(TestMediaArrayInputs(imageArray: &[types::Image], textInput: impl AsRef<str> + BamlEncode, ) -> (stream_types::MediaArrayAnalysisResult, types::MediaArrayAnalysisResult));

baml_function_async!(TestMediaInput(media: &types::Union4AudioOrImageOrPDFOrVideo, textInput: impl AsRef<str> + BamlEncode, ) -> (stream_types::MediaAnalysisResult, types::MediaAnalysisResult));
...
pub struct BamlAsyncClient {
    ...
    pub TestMediaArrayInputs: TestMediaArrayInputs,

    pub TestMediaInput: TestMediaInput,
}
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            TestMediaArrayInputs: TestMediaArrayInputs::new(),

            TestMediaInput: TestMediaInput::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            TestMediaArrayInputs: TestMediaArrayInputs {
                options: options.clone(),
            },

            TestMediaInput: TestMediaInput {
                options: options.clone(),
            },
        }
    }
