...
impl BamlStreamClient {
    ...
    baml_function_stream!(TestMediaArrayInputs(imageArray: &[types::Image], textInput: impl AsRef<str> + BamlEncode, ) -> (stream_types::MediaArrayAnalysisResult, types::MediaArrayAnalysisResult));

    baml_function_stream!(TestMediaInput(media: &types::Union4AudioOrImageOrPDFOrVideo, textInput: impl AsRef<str> + BamlEncode, ) -> (stream_types::MediaAnalysisResult, types::MediaAnalysisResult));
}
