...
baml_function_async!(ConsumeTestEnum(input: &types::TestEnum, ) -> (types::TestEnum, types::TestEnum));
...
pub struct BamlAsyncClient {
    ...
    pub ConsumeTestEnum: ConsumeTestEnum,
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            ConsumeTestEnum: ConsumeTestEnum::new(),
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            ConsumeTestEnum: ConsumeTestEnum {
                options: options.clone(),
            },
