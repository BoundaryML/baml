...
impl TypeBuilder {
    ...
    /// Access the `SimpleClass` class builder.
    pub fn SimpleClass(&self) -> SimpleClassClassBuilder {
        SimpleClassClassBuilder::new(
            self.inner
                .get_class("SimpleClass")
                .expect("class SimpleClass is defined in schema"),
        )
    }
