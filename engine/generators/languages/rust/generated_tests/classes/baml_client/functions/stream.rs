...
impl BamlStreamClient {
    ...
    baml_function_stream!(ConsumeSimpleClass(item: &types::SimpleClass, ) -> (stream_types::SimpleClass, types::SimpleClass));

    baml_function_stream!(MakeSimpleClass() -> (stream_types::SimpleClass, types::SimpleClass));
}
