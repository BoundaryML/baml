...
baml_function_async!(ConsumeSimpleClass(item: &types::SimpleClass, ) -> (stream_types::SimpleClass, types::SimpleClass));

baml_function_async!(MakeSimpleClass() -> (stream_types::SimpleClass, types::SimpleClass));
...
pub struct BamlAsyncClient {
    ...
    pub ConsumeSimpleClass: ConsumeSimpleClass,

    pub MakeSimpleClass: MakeSimpleClass,
}
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            ConsumeSimpleClass: ConsumeSimpleClass::new(),

            MakeSimpleClass: MakeSimpleClass::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            ConsumeSimpleClass: ConsumeSimpleClass {
                options: options.clone(),
            },

            MakeSimpleClass: MakeSimpleClass {
                options: options.clone(),
            },
        }
    }
