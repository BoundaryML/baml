...
baml_function_sync!(ConsumeSimpleClass(item: &types::SimpleClass, ) -> (stream_types::SimpleClass, types::SimpleClass));

baml_function_sync!(MakeSimpleClass() -> (stream_types::SimpleClass, types::SimpleClass));
