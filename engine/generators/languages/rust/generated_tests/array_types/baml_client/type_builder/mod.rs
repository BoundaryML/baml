...
impl TypeBuilder {
    ...
    /// Access the `ArrayWithConstraints` class builder.
    pub fn ArrayWithConstraints(&self) -> ArrayWithConstraintsClassBuilder {
        ArrayWithConstraintsClassBuilder::new(
            self.inner
                .get_class("ArrayWithConstraints")
                .expect("class ArrayWithConstraints is defined in schema"),
        )
    }

    /// Access the `MixedArrays` class builder.
    pub fn MixedArrays(&self) -> MixedArraysClassBuilder {
        MixedArraysClassBuilder::new(
            self.inner
                .get_class("MixedArrays")
                .expect("class MixedArrays is defined in schema"),
        )
    }

    /// Access the `NestedArrays` class builder.
    pub fn NestedArrays(&self) -> NestedArraysClassBuilder {
        NestedArraysClassBuilder::new(
            self.inner
                .get_class("NestedArrays")
                .expect("class NestedArrays is defined in schema"),
        )
    }

    /// Access the `ObjectArrays` class builder.
    pub fn ObjectArrays(&self) -> ObjectArraysClassBuilder {
        ObjectArraysClassBuilder::new(
            self.inner
                .get_class("ObjectArrays")
                .expect("class ObjectArrays is defined in schema"),
        )
    }
    ...
    /// Access the `SimpleArrays` class builder.
    pub fn SimpleArrays(&self) -> SimpleArraysClassBuilder {
        SimpleArraysClassBuilder::new(
            self.inner
                .get_class("SimpleArrays")
                .expect("class SimpleArrays is defined in schema"),
        )
    }

    /// Access the `Tag` class builder.
    pub fn Tag(&self) -> TagClassBuilder {
        TagClassBuilder::new(
            self.inner
                .get_class("Tag")
                .expect("class Tag is defined in schema"),
        )
    }
