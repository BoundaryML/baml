...
baml_function_async!(TestCircularReference(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::CircularReference, types::CircularReference));

baml_function_async!(TestDeepRecursion(depth: i64, ) -> (stream_types::DeepRecursion, types::DeepRecursion));

baml_function_async!(TestEmptyCollections(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::EmptyCollections, types::EmptyCollections));

baml_function_async!(TestLargeStructure(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::LargeStructure, types::LargeStructure));

baml_function_async!(TestNumberEdgeCases(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::NumberEdgeCases, types::NumberEdgeCases));

baml_function_async!(TestSpecialCharacters(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::SpecialCharacters, types::SpecialCharacters));
