...
baml_function_sync!(TestCircularReference(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::CircularReference, types::CircularReference));

baml_function_sync!(TestDeepRecursion(depth: i64, ) -> (stream_types::DeepRecursion, types::DeepRecursion));

baml_function_sync!(TestEmptyCollections(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::EmptyCollections, types::EmptyCollections));

baml_function_sync!(TestLargeStructure(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::LargeStructure, types::LargeStructure));

baml_function_sync!(TestNumberEdgeCases(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::NumberEdgeCases, types::NumberEdgeCases));

baml_function_sync!(TestSpecialCharacters(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::SpecialCharacters, types::SpecialCharacters));
...
pub struct BamlSyncClient {
    ...
    pub TestCircularReference: TestCircularReference,

    pub TestDeepRecursion: TestDeepRecursion,

    pub TestEmptyCollections: TestEmptyCollections,

    pub TestLargeStructure: TestLargeStructure,

    pub TestNumberEdgeCases: TestNumberEdgeCases,

    pub TestSpecialCharacters: TestSpecialCharacters,
}
...
impl BamlSyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            TestCircularReference: TestCircularReference::new(),

            TestDeepRecursion: TestDeepRecursion::new(),

            TestEmptyCollections: TestEmptyCollections::new(),

            TestLargeStructure: TestLargeStructure::new(),

            TestNumberEdgeCases: TestNumberEdgeCases::new(),

            TestSpecialCharacters: TestSpecialCharacters::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            TestDeepRecursion: TestDeepRecursion {
                options: options.clone(),
            },
            ...
            TestLargeStructure: TestLargeStructure {
                options: options.clone(),
            },

            TestNumberEdgeCases: TestNumberEdgeCases {
                options: options.clone(),
            },
