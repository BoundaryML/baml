...
impl BamlClient {
    ...
    baml_function!(TestCircularReference(input: impl AsRef<str> + BamlEncode, ) -> types::CircularReference);

    baml_function!(TestDeepRecursion(depth: i64, ) -> types::DeepRecursion);

    baml_function!(TestEmptyCollections(input: impl AsRef<str> + BamlEncode, ) -> types::EmptyCollections);

    baml_function!(TestLargeStructure(input: impl AsRef<str> + BamlEncode, ) -> types::LargeStructure);

    baml_function!(TestNumberEdgeCases(input: impl AsRef<str> + BamlEncode, ) -> types::NumberEdgeCases);

    baml_function!(TestSpecialCharacters(input: impl AsRef<str> + BamlEncode, ) -> types::SpecialCharacters);
}
