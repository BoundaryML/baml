...
impl BamlStreamClient {
    ...
    baml_function_stream!(MakeClassWithBlockDone() -> (types::ClassWithBlockDone, types::ClassWithBlockDone));

    baml_function_stream!(MakeClassWithExternalDone() -> (types::ClassWithoutDone, types::ClassWithoutDone));

    baml_function_stream!(MakeSemanticContainer() -> (stream_types::SemanticContainer, types::SemanticContainer));
}
