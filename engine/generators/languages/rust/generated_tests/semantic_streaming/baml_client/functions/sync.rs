...
impl BamlClient {
    ...
    baml_function!(MakeClassWithBlockDone() -> types::ClassWithBlockDone);

    baml_function!(MakeClassWithExternalDone() -> types::ClassWithoutDone);

    baml_function!(MakeSemanticContainer() -> types::SemanticContainer);
}
