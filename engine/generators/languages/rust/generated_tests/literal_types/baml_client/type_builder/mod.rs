...
impl TypeBuilder {
    ...
    /// Access the `BooleanLiterals` class builder.
    pub fn BooleanLiterals(&self) -> BooleanLiteralsClassBuilder {
        BooleanLiteralsClassBuilder::new(
            self.inner
                .get_class("BooleanLiterals")
                .expect("class BooleanLiterals is defined in schema"),
        )
    }

    /// Access the `ComplexLiterals` class builder.
    pub fn ComplexLiterals(&self) -> ComplexLiteralsClassBuilder {
        ComplexLiteralsClassBuilder::new(
            self.inner
                .get_class("ComplexLiterals")
                .expect("class ComplexLiterals is defined in schema"),
        )
    }

    /// Access the `IntegerLiterals` class builder.
    pub fn IntegerLiterals(&self) -> IntegerLiteralsClassBuilder {
        IntegerLiteralsClassBuilder::new(
            self.inner
                .get_class("IntegerLiterals")
                .expect("class IntegerLiterals is defined in schema"),
        )
    }

    /// Access the `MixedLiterals` class builder.
    pub fn MixedLiterals(&self) -> MixedLiteralsClassBuilder {
        MixedLiteralsClassBuilder::new(
            self.inner
                .get_class("MixedLiterals")
                .expect("class MixedLiterals is defined in schema"),
        )
    }

    /// Access the `StringLiterals` class builder.
    pub fn StringLiterals(&self) -> StringLiteralsClassBuilder {
        StringLiteralsClassBuilder::new(
            self.inner
                .get_class("StringLiterals")
                .expect("class StringLiterals is defined in schema"),
        )
    }
