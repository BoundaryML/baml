...
impl BamlClient {
    ...
    baml_function!(TestBooleanLiterals(input: impl AsRef<str> + BamlEncode, ) -> types::BooleanLiterals);

    baml_function!(TestComplexLiterals(input: impl AsRef<str> + BamlEncode, ) -> types::ComplexLiterals);

    baml_function!(TestIntegerLiterals(input: impl AsRef<str> + BamlEncode, ) -> types::IntegerLiterals);

    baml_function!(TestMixedLiterals(input: impl AsRef<str> + BamlEncode, ) -> types::MixedLiterals);

    baml_function!(TestStringLiterals(input: impl AsRef<str> + BamlEncode, ) -> types::StringLiterals);
}
