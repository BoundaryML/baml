...
baml_function_sync!(TestBooleanLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::BooleanLiterals, types::BooleanLiterals));

baml_function_sync!(TestComplexLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexLiterals, types::ComplexLiterals));

baml_function_sync!(TestIntegerLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::IntegerLiterals, types::IntegerLiterals));

baml_function_sync!(TestMixedLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::MixedLiterals, types::MixedLiterals));

baml_function_sync!(TestStringLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::StringLiterals, types::StringLiterals));
