...
impl BamlStreamClient {
    ...
    baml_function_stream!(TestBooleanLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::BooleanLiterals, types::BooleanLiterals));

    baml_function_stream!(TestComplexLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexLiterals, types::ComplexLiterals));

    baml_function_stream!(TestIntegerLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::IntegerLiterals, types::IntegerLiterals));

    baml_function_stream!(TestMixedLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::MixedLiterals, types::MixedLiterals));

    baml_function_stream!(TestStringLiterals(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::StringLiterals, types::StringLiterals));
}
