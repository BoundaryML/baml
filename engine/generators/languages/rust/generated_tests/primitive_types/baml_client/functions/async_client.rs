...
baml_function_async!(TestEmptyCollections(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveArrays, types::PrimitiveArrays));

baml_function_async!(TestMixedPrimitives(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::MixedPrimitives, types::MixedPrimitives));

baml_function_async!(TestPrimitiveArrays(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveArrays, types::PrimitiveArrays));

baml_function_async!(TestPrimitiveMaps(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveMaps, types::PrimitiveMaps));

baml_function_async!(TestPrimitiveTypes(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveTypes, types::PrimitiveTypes));

baml_function_async!(TestTopLevelBool(input: impl AsRef<str> + BamlEncode, ) -> (bool, bool));

baml_function_async!(TestTopLevelFloat(input: impl AsRef<str> + BamlEncode, ) -> (f64, f64));

baml_function_async!(TestTopLevelInt(input: impl AsRef<str> + BamlEncode, ) -> (i64, i64));

baml_function_async!(TestTopLevelNull(input: impl AsRef<str> + BamlEncode, ) -> ((), ()));

baml_function_async!(TestTopLevelString(input: impl AsRef<str> + BamlEncode, ) -> (String, String));
