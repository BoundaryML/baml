...
baml_function_sync!(TestEmptyCollections(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveArrays, types::PrimitiveArrays));

baml_function_sync!(TestMixedPrimitives(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::MixedPrimitives, types::MixedPrimitives));

baml_function_sync!(TestPrimitiveArrays(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveArrays, types::PrimitiveArrays));

baml_function_sync!(TestPrimitiveMaps(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveMaps, types::PrimitiveMaps));

baml_function_sync!(TestPrimitiveTypes(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveTypes, types::PrimitiveTypes));

baml_function_sync!(TestTopLevelBool(input: impl AsRef<str> + BamlEncode, ) -> (bool, bool));

baml_function_sync!(TestTopLevelFloat(input: impl AsRef<str> + BamlEncode, ) -> (f64, f64));

baml_function_sync!(TestTopLevelInt(input: impl AsRef<str> + BamlEncode, ) -> (i64, i64));

baml_function_sync!(TestTopLevelNull(input: impl AsRef<str> + BamlEncode, ) -> ((), ()));

baml_function_sync!(TestTopLevelString(input: impl AsRef<str> + BamlEncode, ) -> (String, String));
...
pub struct BamlSyncClient {
    ...
    pub TestEmptyCollections: TestEmptyCollections,

    pub TestMixedPrimitives: TestMixedPrimitives,

    pub TestPrimitiveArrays: TestPrimitiveArrays,

    pub TestPrimitiveMaps: TestPrimitiveMaps,

    pub TestPrimitiveTypes: TestPrimitiveTypes,

    pub TestTopLevelBool: TestTopLevelBool,

    pub TestTopLevelFloat: TestTopLevelFloat,

    pub TestTopLevelInt: TestTopLevelInt,

    pub TestTopLevelNull: TestTopLevelNull,

    pub TestTopLevelString: TestTopLevelString,
}
...
impl BamlSyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            TestEmptyCollections: TestEmptyCollections::new(),

            TestMixedPrimitives: TestMixedPrimitives::new(),

            TestPrimitiveArrays: TestPrimitiveArrays::new(),

            TestPrimitiveMaps: TestPrimitiveMaps::new(),

            TestPrimitiveTypes: TestPrimitiveTypes::new(),

            TestTopLevelBool: TestTopLevelBool::new(),

            TestTopLevelFloat: TestTopLevelFloat::new(),

            TestTopLevelInt: TestTopLevelInt::new(),

            TestTopLevelNull: TestTopLevelNull::new(),

            TestTopLevelString: TestTopLevelString::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            TestMixedPrimitives: TestMixedPrimitives {
                options: options.clone(),
            },

            TestPrimitiveArrays: TestPrimitiveArrays {
                options: options.clone(),
            },

            TestPrimitiveMaps: TestPrimitiveMaps {
                options: options.clone(),
            },
            ...
            TestTopLevelBool: TestTopLevelBool {
                options: options.clone(),
            },

            TestTopLevelFloat: TestTopLevelFloat {
                options: options.clone(),
            },

            TestTopLevelInt: TestTopLevelInt {
                options: options.clone(),
            },

            TestTopLevelNull: TestTopLevelNull {
                options: options.clone(),
            },

            TestTopLevelString: TestTopLevelString {
                options: options.clone(),
            },
        }
    }
