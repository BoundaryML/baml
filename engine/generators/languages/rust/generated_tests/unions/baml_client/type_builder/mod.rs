...
impl TypeBuilder {
    ...
    /// Access the `ExistingSystemComponent` class builder.
    pub fn ExistingSystemComponent(&self) -> ExistingSystemComponentClassBuilder {
        ExistingSystemComponentClassBuilder::new(
            self.inner
                .get_class("ExistingSystemComponent")
                .expect("class ExistingSystemComponent is defined in schema"),
        )
    }

    /// Access the `UseMyUnion` class builder.
    pub fn UseMyUnion(&self) -> UseMyUnionClassBuilder {
        UseMyUnionClassBuilder::new(
            self.inner
                .get_class("UseMyUnion")
                .expect("class UseMyUnion is defined in schema"),
        )
    }
