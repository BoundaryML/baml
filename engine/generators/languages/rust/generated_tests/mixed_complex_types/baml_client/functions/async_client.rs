...
baml_function_async!(TestKitchenSink(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::KitchenSink, types::KitchenSink));

baml_function_async!(TestRecursiveComplexity(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::Node, types::Node));

baml_function_async!(TestUltraComplex(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::UltraComplex, types::UltraComplex));
