...
impl BamlClient {
    ...
    baml_function!(TestKitchenSink(input: impl AsRef<str> + BamlEncode, ) -> types::KitchenSink);

    baml_function!(TestRecursiveComplexity(input: impl AsRef<str> + BamlEncode, ) -> types::Node);

    baml_function!(TestUltraComplex(input: impl AsRef<str> + BamlEncode, ) -> types::UltraComplex);
}
