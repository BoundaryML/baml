...
baml_function_sync!(TestKitchenSink(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::KitchenSink, types::KitchenSink));

baml_function_sync!(TestRecursiveComplexity(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::Node, types::Node));

baml_function_sync!(TestUltraComplex(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::UltraComplex, types::UltraComplex));
...
pub struct BamlSyncClient {
    ...
    pub TestKitchenSink: TestKitchenSink,

    pub TestRecursiveComplexity: TestRecursiveComplexity,

    pub TestUltraComplex: TestUltraComplex,
}
...
impl BamlSyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            TestKitchenSink: TestKitchenSink::new(),

            TestRecursiveComplexity: TestRecursiveComplexity::new(),

            TestUltraComplex: TestUltraComplex::new(),
        }
    }
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            TestRecursiveComplexity: TestRecursiveComplexity {
                options: options.clone(),
            },

            TestUltraComplex: TestUltraComplex {
                options: options.clone(),
            },
        }
    }
