...
impl BamlStreamClient {
    ...
    baml_function_stream!(TestKitchenSink(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::KitchenSink, types::KitchenSink));

    baml_function_stream!(TestRecursiveComplexity(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::Node, types::Node));

    baml_function_stream!(TestUltraComplex(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::UltraComplex, types::UltraComplex));
}
