...
impl TypeBuilder {
    ...
    /// Access the `Article` class builder.
    pub fn Article(&self) -> ArticleClassBuilder {
        ArticleClassBuilder::new(
            self.inner
                .get_class("Article")
                .expect("class Article is defined in schema"),
        )
    }
    ...
    /// Access the `Priority` enum builder.
    pub fn Priority(&self) -> PriorityEnumBuilder {
        PriorityEnumBuilder::new(
            self.inner
                .get_enum("Priority")
                .expect("enum Priority is defined in schema"),
        )
    }
