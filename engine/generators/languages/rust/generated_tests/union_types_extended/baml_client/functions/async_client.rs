...
baml_function_async!(TestComplexUnions(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ComplexUnions, types::ComplexUnions));

baml_function_async!(TestDiscriminatedUnions(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::DiscriminatedUnions, types::DiscriminatedUnions));

baml_function_async!(TestPrimitiveUnions(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::PrimitiveUnions, types::PrimitiveUnions));

baml_function_async!(TestUnionArrays(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::UnionArrays, types::UnionArrays));
