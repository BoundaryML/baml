...
impl BamlStreamClient {
    ...
    baml_function_stream!(Bar(x: i64, ) -> (stream_types::Union2ExampleOrExample2, types::Union2ExampleOrExample2));

    baml_function_stream!(Foo(x: i64, ) -> (stream_types::Union2ExampleOrExample2, types::Union2ExampleOrExample2));
}
