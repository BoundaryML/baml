...
use internal_baml_core::ir::{repr::IntermediateRepr, Expression};
...
pub(crate) fn generate_ruby(ir: &IntermediateRepr) -> std::io::Result<()> {
    ...
    collector.commit(&"/tmp/does/not/exist".to_string().into())
}
