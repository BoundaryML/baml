...
use crate::generate::{dir_writer::WithFileContent, ir::Client};
...
impl WithFileContent<TSLanguageFeatures> for Client {
    ...
    fn write(&self, collector: &mut TSFileCollector) {
        ...
        file.add_import("../baml_lib/client_manager", "clientManager", None, false);
