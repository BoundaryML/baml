...
impl FileCollector {
    pub fn start_export_py_file<'a>(&'a mut self, path: impl AsRef<str>, name: impl AsRef<str>) {
        self.start_file_impl(path, name, true, "py");
    }
    pub fn start_py_file<'a>(&'a mut self, path: impl AsRef<str>, name: impl AsRef<str>) {
        self.start_file_impl(path, name, false, "py");
    }

    pub fn start_export_ts_file<'a>(&'a mut self, path: impl AsRef<str>, name: impl AsRef<str>) {
        self.start_file_impl(path, name, true, "ts");
    }
    pub fn start_ts_file<'a>(&'a mut self, path: impl AsRef<str>, name: impl AsRef<str>) {
        self.start_file_impl(path, name, false, "ts");
    }

    fn start_file_impl<'a>(
        &'a mut self,
        path: impl AsRef<str>,
        name: impl AsRef<str>,
        is_export: bool,
