use super::{
    Attribute, Comment, ConfigBlockProperty, Expression, Identifier, Span, WithDocumentation,
...
impl std::ops::Index<FieldId> for PrinterConfig {
...
impl WithIdentifier for PrinterConfig {
    fn identifier(&self) -> &Identifier {
        &self.name
    }
}

impl WithSpan for PrinterConfig {
    fn span(&self) -> &Span {
        &self.span
    }
}

impl WithDocumentation for PrinterConfig {
