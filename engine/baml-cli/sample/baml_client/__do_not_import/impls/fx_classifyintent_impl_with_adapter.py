...
k2: When the query is directly asking about availability
SetReminder

Output JSON: "User Intents as string"[]
...
__deserializer.overload("Intent", {"k1": "BookMeeting", "k2": "AvailabilityQuery"})
...
@BAMLClassifyIntent.register_impl("with_adapter")
async def with_adapter(*, query: str) -> List[Intent]:
