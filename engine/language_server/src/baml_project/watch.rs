...
pub enum ChangeEvent {
    ...
    Created { path: PathBuf, kind: CreatedKind },

    /// The content or metadata of a path was changed.
    Changed { path: PathBuf, kind: ChangedKind },

    /// A path was deleted.
    Deleted { path: PathBuf, kind: DeletedKind },
...
impl ChangeEvent {
    ...
    pub fn file_content_changed(path: PathBuf) -> ChangeEvent {
        ChangeEvent::Changed {
            path,
