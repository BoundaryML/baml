...
//!
//! - On native targets it is implemented directly on
//!   hyper/hyper-util/hyper-rustls. This keeps the dependency tree small and
//!   makes the engine vendorable in monorepos where reqwest is not
//!   importable.
