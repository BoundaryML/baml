...
class Timing:
    def __init__(self, start_time: str, end_time: str, duration: int, time_to_first_parsed_ms: int) -> None: ...
    @property
    def start_time_utc_ms(self) -> int: ...
    @property
    def duration_ms(self) -> int: ...
    @property
    def time_to_first_parsed_ms(self) -> int: ...
...
class LLMStreamCall(LLMCall):
    def __init__(self, client_name: str, provider: str, timing: StreamTiming, request: Dict[str, Any], response: Dict[str, Any], usage: Usage) -> None: ...
    # TODO: add chunks
...
class Collector:
    ...
    def events(self) -> List[FunctionLog]: ...
    @staticmethod
