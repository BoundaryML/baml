...
- [AbortController](/03-reference/baml_client/abort-controller) - API reference for abort controllers
- [Error Overview](/03-reference/baml_client/errors/overview) - Complete error hierarchy
- [User Guide: Abort Controllers](/01-guide/04-baml-basics/abort-controllers) - Learn how to use abort controllers
- [Error Handling Guide](/01-guide/04-baml-basics/error-handling) - General error handling patterns