...
When using [fallback clients](/ref/llm-client-strategies/fallback) or clients with [retry policies](/ref/baml/clients/strategy/retry), BAML attempts multiple client calls before finally failing. In these cases:
