...
- **OpenAI**: By default converts to base64 (`always`) for compatibility.
- **Vertex AI**: By default uses `ensure_mime` to include MIME type.
- **Other providers**: By default keep URLs as-is (`never`).
