...
Provider defaults:
- **[OpenAI](/baml/clients/providers/openai#media_url_resolver)**: Keeps URLs as-is (`never`)
- **[Anthropic](/baml/clients/providers/anthropic#media_url_resolver)**: Keeps URLs as-is (`never`)
- **[Google AI](/baml/clients/providers/google-ai#media_url_resolver)**: Keeps URLs as-is (`never`)
- **[Vertex AI](/baml/clients/providers/vertex#media_url_resolver)**: Keeps URLs as-is (`never`)
- **[AWS Bedrock](/baml/clients/providers/aws-bedrock#media_url_resolver)**: Keeps URLs as-is (`never`)

You can override this behavior using `media_url_resolver.video` in your client configuration, but be aware of size limitations when using `always` mode.
