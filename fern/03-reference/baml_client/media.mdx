...
BAML automatically handles URL-to-base64 conversion based on provider requirements. You can control this behavior using the `media_url_resolver` configuration option in your client definition.
...
See the [client configuration documentation](/reference/baml/clients/providers) for provider-specific defaults and configuration options.
