...
<ParamField
  ...
  type="string"
>
  The model to use with the Responses API.
...
| Value    | Description                    |
| -------- | ------------------------------ |
| `auto`   | Model chooses tool automatically |
| `none`   | Model doesn't use any tools      |
...
Read more about the differences in [OpenAI's comparison guide](https://platform.openai.com/docs/guides/responses-vs-chat-completions).
