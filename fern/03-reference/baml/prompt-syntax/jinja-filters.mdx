...
| `toon` | Token-efficient TOON output | `indent`, `delimiter`, `length_marker` |
...
For more details on the TOON format, see the [TOON specification](https://github.com/toon-format/toon).
