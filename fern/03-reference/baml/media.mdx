...
This allows you to override the default behavior for each provider and media type combination. See [client configuration](/baml/clients/providers#media_url_handler) for details.
