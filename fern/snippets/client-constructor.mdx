...
| `orcarouter`     | [OrcaRouter](/ref/llm-client-providers/orcarouter)           | Supports [/chat/completions](https://www.orcarouter.ai) endpoint on `https://api.orcarouter.ai/v1` |
...
| OrcaRouter | [OrcaRouter](/ref/llm-client-providers/orcarouter) |
