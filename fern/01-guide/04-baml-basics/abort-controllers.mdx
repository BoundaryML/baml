...
See the [Concurrent Calls guide](/01-guide/04-baml-basics/concurrent-calls#cancelling-parallel-operations) for detailed examples and implementations.

## Related Topics

- [Error Handling](/01-guide/04-baml-basics/error-handling) - Learn about all error types including BamlAbortError
- [Streaming](/01-guide/04-baml-basics/streaming#cancelling-streams) - Stream responses with cancellation support
- [Concurrent Calls](/01-guide/04-baml-basics/concurrent-calls) - Advanced cancellation patterns for parallel operations
