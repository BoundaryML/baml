...
Other times you may extract all the form fields from a any document (which you don't know the structure of beforehand), and you want to ensure the LLM fills them in correctly.

**Dynamic types are types that can be modified or created at runtime**, which means you can
change the output schema of a function at runtime.

The best way to understand dynamic types is to see some examples.
...
2. Create a TypeBuilder and modify `Category`. All dynamic types you
