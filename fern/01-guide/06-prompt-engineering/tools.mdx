...
async def main():
    weather_info = await b.UseTool("What's the weather like in San Francisco?")
    print(weather_info)
...
async def main():
    tool = await b.UseTool("What's the weather like in San Francisco?")
    print(tool)
...
async def main():
    tools = await b.UseTool("What's the weather like in San Francisco and New York?")
    print(tools)
