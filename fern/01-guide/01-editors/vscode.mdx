...
<Tip>
- Toggle the `🚀` to enable running the tests in parrelel.
</Tip>
...
You can switch between test cases by selecting it in the results pain or the test selection pane on the right.
