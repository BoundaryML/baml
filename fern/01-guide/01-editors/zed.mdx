...
<Note>
The BAML Playground is not currently available in the Zed extension. For playground functionality, we recommend using [VS Code](/guide/installation-editors/vscode) or a [JetBrains IDE](/guide/installation-editors/jetbrains).
</Note>
