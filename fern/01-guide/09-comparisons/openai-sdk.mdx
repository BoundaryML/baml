...
But in production, you need more:
- **Model flexibility** - Try Claude, Gemini, or Llama
- **Prompt control** - See and optimize what's sent  
- **Real testing** - Without burning tokens
- **Production features** - Retries, fallbacks, routing

With BAML, you get all of this while keeping your code simple.
