---
title: Foundations
description: Orientation · Learn how source files, types, functions, and generated clients fit together.
breadcrumbs:
  - href: /baml
    label: BAML
  - href: /baml/book
...
<div className="docs-card-grid">
  <DocsCard description="Define typed inputs and outputs, write a body, and understand the generated call surface." href="/baml/book/foundations/functions" title="Functions" />
</div>
