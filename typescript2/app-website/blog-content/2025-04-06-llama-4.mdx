---
title: Structured outputs with Llama 4
description: How to do tool-calling or function-calling with Llama 4
slug: llama-4-function-calling
date: April 6, 2025
tags: ['tutorials']
author:
  name: Vaibhav Gupta
...
Meta's [Llama 4](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) is the newest 
release of the Llama series. It touts native multi-modality and 
a Mixture of Experts (MoE) architecture and can be used for tool-calling / function-calling.
