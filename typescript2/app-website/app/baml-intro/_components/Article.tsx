      ...
      {view !== 'intro' && (
        <>
          ...
          <Section id="run-fn" num="3" title="baml run <function>">
            <p>
              {
                '[placeholder: run a single named function straight from the CLI, e.g. `baml run my_function --arg ...`. Check ~/repos/sheep-council/week-2 for the exact invocation/output.]'
              }
            </p>
          </Section>
          ...
          <Part eyebrow="Part 3" id="human-tools" title="Tools for humans">
            <p>
              {
                '[placeholder: intro — humans still need to see and trust what the AI is doing.]'
              }
            </p>
          </Part>
          ...
          <Part eyebrow="Part 4" id="usable" title="How we make BAML usable">
            <p>
              {
                '[placeholder: intro — what it takes to actually adopt and trust BAML in a real codebase.]'
              }
            </p>
          </Part>
          ...
          <Part eyebrow="Part 5" id="agents" title="Building agents">
            <p>
              {
                "[placeholder: opener — “We didn't forget about building agents! The kind of software we're starting to build is changing too.”]"
              }
            </p>
            <p>
