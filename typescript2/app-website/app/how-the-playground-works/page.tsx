      ...
      <main className="flex flex-col min-h-screen w-full px-6 md:px-12 py-16 md:py-24">
        <article className="prose prose-neutral max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-10">
            The playground you just used is running the real BAML compiler —
            not a simulation, not a server. Everything happens in your browser.
          </p>
          ...
          <p className="mb-6">
            ...
            power the CLI, the VSCode extension, the Python/TypeScript/Ruby SDKs,
            and this playground without rewriting the language for each host.
          </p>
          ...
          <p className="mb-6">
            ...
            The result is a single <code className="px-1.5 py-0.5 rounded bg-muted">.wasm</code>{' '}
            module plus a thin JavaScript wrapper that exposes the compiler to
            the browser as ordinary JS functions. WebAssembly runs at near-native
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              Your BAML source lives in an in-memory virtual file system.
            </li>
            <li>
              Every keystroke feeds the source into the WASM compiler, which
              parses it, resolves types, and returns diagnostics — the same
              ones you would see from the CLI.
            </li>
            <li>
              When you hit <strong>Run</strong>, the compiler renders the prompt
              for the selected function and calls the LLM provider directly
              from your browser using the API key you supply. No BAML server
              sees your keys or your data.
            </li>
            <li>
