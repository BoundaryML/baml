export default function WarEpilogue() {
  return (
    <section className="tweet-font mx-auto max-w-3xl px-6 pb-8 pt-16 sm:pt-24">
      ...
      <h2 className="mt-16 text-center text-3xl font-bold tracking-tight text-accent sm:text-5xl">
        We need BAML
      </h2>

      <p className="mx-auto mt-12 max-w-2xl text-center text-2xl font-medium leading-relaxed text-ink sm:text-[2rem] sm:leading-snug">
        {'Our bet at '}
