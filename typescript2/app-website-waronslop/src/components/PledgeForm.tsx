...
function ShareCard({ name, dispatch }: { name: string; dispatch: string }) {
  ...
  return (
    <div className="tweet-font">
      ...
      <p className="mt-1 text-ink-2">Your pledge is on the wall below. Share your card:</p>

      <canvas
        ref={canvasRef}
        className="mt-4 w-full rounded-xl border border-ink/15 shadow-sm"
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        <button
          onClick={shareToX}
          className="inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-bold text-cream-hi transition hover:opacity-90"
        >
          Share on
        ...
        <button
          onClick={download}
          className="text-sm font-bold text-accent underline underline-offset-4 hover:text-accent-deep"
        >
          Download card
        </button>
      </div>
      <p className="mt-2 text-xs text-ink-2/70">Download the card, then attach it to your post.</p>
    </div>
  );
}
    ...
    return (
      <div className="bg-transparent py-2 text-left">
        ...
        <button
          ...
          className="tweet-font mt-4 text-sm font-bold text-accent underline underline-offset-4 hover:text-accent-deep"
        >
          Add another
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="mt-5">
        ...
        <div className="mt-1 text-right text-xs font-bold text-ink/45">
