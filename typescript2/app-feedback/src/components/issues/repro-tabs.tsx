...
function label(r: Repro, i: number): string {
  ...
  const result = r.result === "fails" ? "fails" : r.result === "passes" ? "passes" : r.result === "invalid_repro" ? "invalid example" : r.result === "unsupported_verification" ? "verification unavailable" : r.result === "verification_error" ? "execution error" : r.result === "inconclusive" ? "inconclusive" : null;
