  ...
  function openReport(event: MouseEvent<HTMLDivElement>) {
    ...
    if (
      ![
        ...
        'https://app-feedback-phi.vercel.app',
        'https://app-feedback-baml.vercel.app',
        'https://atb2-feedback.fly.dev',
      ].includes(url.origin)
    )
      return;
      ...
      >
        <div className="min-h-full p-6">
          <header className="mb-5 flex items-center justify-between gap-4 border-b pb-4">
            <h2 className="font-semibold" id="feedback-panel-title">
              Original feedback
            </h2>
            <button
            ...
            {report && (
              <article className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  UTC{report.toolchain && ` · BAML ${report.toolchain}`}
                </p>
