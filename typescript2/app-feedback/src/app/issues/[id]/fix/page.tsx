  ...
  return (
    <main className="mx-auto max-w-4xl space-y-8 px-4 py-6">
        ...
        {!o ? (
          ...
          <dl className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-4 gap-y-1 rounded-lg border bg-card p-4 text-sm">
            ...
            <dd className="tabular-nums">
              ...
              {o.timed_out && (
                <span className="text-stage-failed"> (killed at budget)</span>
              )}
            </dd>
            {o.reason && (
              <>
            ...
            {o.branch && (
              <>
                ...
                <dd className="font-mono text-xs break-all">{o.branch}</dd>
              </>
            )}
            {pr && (
              <>
      ...
      {issue.design_doc && (
        <section>
          <h2 className="mb-2 text-xs uppercase tracking-wide text-muted-foreground">
            Design doc (agent, read-only pass)
          </h2>
