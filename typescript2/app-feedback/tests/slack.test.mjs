...
test('Slack links reject external hosts, credentials, and redirects', () => {
  for (const url of [
    'javascript:alert(1)',
    'http://team.slack.com/archives/C123',
    'https://team.slack.com.attacker.invalid/archives/C123',
    'https://attacker.invalid/archives/C123',
    'https://slack.com/redirect',
    ...
    'https://team.slack.com/archives/C123#redirect',
    '',
    'not-a-url',
  ])
    expect(slackChannelUrl(url)).toBeNull();
  expect(slackChannelUrl('https://team.slack.com/archives/C123')).toBe(
