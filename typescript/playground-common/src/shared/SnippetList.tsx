...
const textComponents = [
...

  {
    ...
    text1:
      'Streaming partial objects is useful if you want to start processing the response before it’s fully complete. You can stream anything from a string output type, to a complex object.',
    lang: 'python',
...
const TextComponentList = ({ selectedId }: { selectedId: String }) => {
  ...
  return selectedComponent ? (
    <SnippetCard
      ...
      description={selectedComponent.text1}
      code={selectedComponent.text2}
      lang={selectedComponent.lang}
    />
  ) : null
}
