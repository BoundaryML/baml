...
export class BamlSyncClient {
  ...
  ExtractResume(resume: string, __baml_options__?: BamlCallOptions): types.Resume {
    try {
  ...
  PlanQuery(query: types.Query, __baml_options__?: BamlCallOptions): types.QueryActionPlan {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) };
      const collector = options.collector
        ? Array.isArray(options.collector)
