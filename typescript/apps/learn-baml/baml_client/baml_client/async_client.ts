...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async AskBaml(
        input: types.AskBamlInput,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.AskBamlOutput> {
          try {
          ...
          const __stream__ = this.stream.AskBaml(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.AskBamlOutput
            } catch (error) {
            ...
            input: types.AskBamlInput,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.AskBamlOutput, types.AskBamlOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AskBaml", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.AskBamlOutput, types.AskBamlOutput>(
                  __raw__,
                  (a): partial_types.AskBamlOutput => a,
                  (a): types.AskBamlOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
