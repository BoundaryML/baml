...
class BAMLBooleanFuncImpl:
    ...
    def stream(self, arg: bool, /) -> AsyncStream[str, str]:
        ...

class IBAMLBooleanFunc:
    def register_impl(
        self, name: ImplName
    ) -> typing.Callable[[IBooleanFunc, IBooleanFuncStream], None]:
        ...
    ...
    def test(self, *, exclude_impl: typing.Iterable[ImplName] = [], stream: bool = False) -> pytest.MarkDecorator:
        ...
        Usage:
            ...
            @baml.BooleanFunc.test(exclude_impl=["implname"])
            async def test_logic(BooleanFuncImpl: IBooleanFunc) -> None:
                result = await BooleanFuncImpl(...)
            ```
            ...
            @baml.BooleanFunc.test(stream=True)
            async def test_logic(BooleanFuncImpl: IBooleanFuncStream) -> None:
                async for result in BooleanFuncImpl(...):
                    ...
            ```
        """
        ...
