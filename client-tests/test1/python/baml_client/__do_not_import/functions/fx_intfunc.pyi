...
class BAMLIntFuncImpl:
    ...
    def stream(self, arg: int, /) -> AsyncStream[str, str]:
        ...

class IBAMLIntFunc:
    def register_impl(
        self, name: ImplName
    ) -> typing.Callable[[IIntFunc, IIntFuncStream], None]:
        ...
    ...
    def test(self, *, exclude_impl: typing.Iterable[ImplName] = [], stream: bool = False) -> pytest.MarkDecorator:
        ...
        Usage:
            ...
            @baml.IntFunc.test(exclude_impl=["implname"])
            async def test_logic(IntFuncImpl: IIntFunc) -> None:
                result = await IntFuncImpl(...)
            ```
            ...
            @baml.IntFunc.test(stream=True)
            async def test_logic(IntFuncImpl: IIntFuncStream) -> None:
                async for result in IntFuncImpl(...):
                    ...
            ```
        """
        ...
