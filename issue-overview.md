...
- 2026-07-28: Automated validation from `typescript2/` passed with `pnpm --filter app-promptfiddle typecheck`, `pnpm --filter app-promptfiddle build`, and `pnpm exec biome check pkg-editor/src/views-workbench.css`.
