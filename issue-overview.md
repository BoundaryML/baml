...
- 2026-07-28: Reviewed the bug report: Monaco breadcrumb dropdown controls for `sdk-parity-lint` and `baml_src` overlap adjacent text instead of maintaining normal spacing.
