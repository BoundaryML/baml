...
The independently versioned live wrapper catalog is 0.2.4 and advertises GNU/musl builds for both Linux architectures. Its git tag points to 2fa0d0df4d0898ddc985be5a501c803a8ff35836, before #4632. Published wrapper contents therefore remain a concrete verification gate before the #4624 notification. The original PR records four-platform before/after bootstrap integration runs; they are not a substitute for checking the final published artifacts.
