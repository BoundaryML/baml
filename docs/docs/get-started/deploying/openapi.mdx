...
If you plan to use [Boundary Cloud](/docs/boundary-cloud/host-your-baml-functions) to host your BAML functions, you should also update it to use `BOUNDARY_API_KEY`.
