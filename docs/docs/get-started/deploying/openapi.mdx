...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            var bamlEndpoint = Environment.GetEnvironmentVariable("BAML_ENDPOINT");
            if (!string.IsNullOrEmpty(bamlEndpoint))
            {
                config.BasePath = bamlEndpoint;
            }
...
import (
    "os"
    openapiclient "path/to/your/openapi/client"
)
