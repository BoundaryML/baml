...
| -------------- | -------------------------------- | ---------------------------------------------------------- |
| `openai`       | [OpenAI](providers/openai.mdx)       | Anything that follows openai's API exactly                 |
| `ollama`       | [Ollama](providers/ollama.mdx)       | Alias for an openai client but with default ollama options |
| `azure-openai` | [Azure OpenAI](providers/azure.mdx)  |                                                            |
| `anthropic`    | [Anthropic](providers/anthropic.mdx) |                                                            |
| `google-ai`    | [Google AI](providers/gemini.mdx)    |                                                            |
| `fallback`     | [Fallback](fallback.mdx)             | Used to chain models conditional on failures               |
| `round-robin`  | [Round Robin](round-robin.mdx)       | Used to load balance                                       |
