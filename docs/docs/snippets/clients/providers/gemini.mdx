...
The `google-ai` provider supports the `https://generativelanguage.googleapis.com/v1/models/{model_id}/generateContent` and `https://generativelanguage.googleapis.com/v1/models/{model_id}/streamGenerateContent` endpoints.
...
The `google-ai` endpoints do not support URL-based media input.
BAML will automatically convert any URL-based media input to base64 before sending it to the API. */}
