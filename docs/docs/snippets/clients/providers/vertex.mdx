...
<ParamField path="base_url" type="string">
  The base URL for the API. **Default: `https://us-central1-aiplatform.googleapis.com/v1/projects/${PROJECT_ID}/locations/us-central1/publishers/google/models/gemini-1.5-flash:streamGenerateContent
`**
</ParamField>
