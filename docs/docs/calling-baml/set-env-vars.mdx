...
```text OpenAPI
Make sure to set the environment variables wherever you run `baml-cli dev` or `baml-cli serve`.

See the [deployment instructions](/docs/get-started/deploying/openapi) to learn more.
```
