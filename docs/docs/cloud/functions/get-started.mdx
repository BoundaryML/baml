...
Boundary Cloud allows you to host your BAML functions on our infrastructure, exposing
...
This guide will walk you through:
  ...
  - deploying your BAML code to Boundary Cloud,
...
<div class="flex flex-col items-center">
  <img class="rounded-md px-4 py-2 m-0" src="/assets/cloud/deploy-screenshot.png" alt="Boundary Cloud deploy output" />
</div>
...
<div class="flex flex-col items-center">
  <img class="rounded-md px-4 py-2 m-0" src="/assets/cloud/local-function-call.png" alt="Boundary Cloud deploy output" />
</div>
