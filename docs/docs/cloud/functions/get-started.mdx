...
This will take you to https://dashboard.boundaryml.com, where you'll create an account and your organization.
...
which will set up a new Boundary project for you, deploy your BAML code to it, point you to the dashboard, where you can set environment variables and create API keys.
