...
_Learn how to use your OpenAPI client to call your functions in Boundary Cloud._

<Info>
  This page assumes you've already deployed your BAML code to Boundary Cloud. If
  you haven't done that yet, check out the guide for [getting started](/cloud).
</Info>
...
<div class="flex flex-col items-center">
  <img src="/assets/cloud/api-keys.png" alt="Boundary Cloud API keys" />
</div>
