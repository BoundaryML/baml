---
title: "crypto.XChaCha20Poly1305"
description: "Class crypto.XChaCha20Poly1305 from the generated baml package reference."
---
...
```baml
class crypto.XChaCha20Poly1305
```
...
```baml
function new(key: uint8array) -> baml.crypto.XChaCha20Poly1305 throws baml.errors.InvalidArgument
```

No description is available yet.

_Source: `<builtin>/baml/ns_crypto/chacha20poly1305.baml:5561`_
