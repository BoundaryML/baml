---
title: "csv.WriterOptions"
description: "Class csv.WriterOptions from the generated baml package reference."
---

Options for CSV writers. All fields are optional; `null` means default.

```baml
class csv.WriterOptions
```
...
_Source: `<builtin>/baml/ns_csv/csv.baml:5282`_
