---
title: "errors.TypeMismatch$stream"
description: "Class errors.TypeMismatch$stream from the generated baml package reference."
---
...
```baml
class errors.TypeMismatch$stream
```
...
_Source: `<builtin>/baml/ns_errors/errors.baml:0`_
