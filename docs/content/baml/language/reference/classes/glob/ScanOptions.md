---
title: "glob.ScanOptions"
description: "Class glob.ScanOptions from the generated baml package reference."
---

Options for `Glob.scan`.

```baml
class glob.ScanOptions
```
...
_Source: `<builtin>/baml/ns_glob/glob.baml:29`_
