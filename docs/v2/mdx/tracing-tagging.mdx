...
Gloo allows you to trace any function with the **@trace** decorator.
This will make the function's input and output show up in the dashboard. This works for any python function you define yourself.

### Prerequisites
Make sure you setup the [BAML dashboard](/installation#setting-up-the-gloo-dashboard) project before you start.
