...
To do this we can add `attributes` to an enum or class, denoted with the **@**, and then leverage the built-in **print_enum** helper function to print out the enum values in our prompt.
