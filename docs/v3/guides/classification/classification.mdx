...
#### Prerequisites
Go through the installation steps in the [installation](/v3/home/installation) section.

#### 1. Define your task in BAML
Declare an **AI function** in your BAML file with the following signature:
