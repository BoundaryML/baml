...
BAML libraries ship with the following providers (you can can also write your own!):
...
automatically map it to a chat prompt and similarly you can call a completion
