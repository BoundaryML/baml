...
- 🔨 AI Engineers are left **context switching** between different tools (testing / playground UIs / multiple wrapper libraries) to implement AI functions.
...
- Lastly, **Testing is hard** (and therefore usually not done). This applies for most code, but is especially hard for non-deterministic AI systems. And when tests/AI configurations live outside of the codebase, CI/CD becomes impossible.
