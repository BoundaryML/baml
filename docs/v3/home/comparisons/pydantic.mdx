...
--- 
Sidenote: At this point your prompt looks like this mess:
...
### Alternatives
There are libraries like [instructor](https://github.com/jxnl/instructor/tree/main) do provide a great amount of boilerplate (and we are also inspired by them) but you're still:

1. Stuck with OpenAI. You may not be able to switch to your own fine-tuned model easily.
...
<Note>
Here we use a "GPT4" client, but you can use any model. See [client docs](/v3/syntax/client/client)
</Note>
{/* 
```rust
...
Adding retries or resilience requires just [a couple of modifications](/v3/syntax/client/retry). And best of all, **you can test things instantly, without leaving your VSCode**:
...
### Conclusion
We built a compiler because writing a Python library was just not powerful enough to do everything we envisioned, as we have just explored.

Check out the [Hello World](/v3/guides/hello_world/level0) tutorial to get started.
