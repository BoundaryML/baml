...
def test_user_namespace_via_submodule():
    from baml_client.baml_types.foo import Sentiment
    assert Sentiment is not None


def test_user_namespace_via_attribute_access():
    from baml_client import baml_types
