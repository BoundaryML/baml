...
- Added targeted reflection diagnostics when unspecialized generic functions are extracted or invoked dynamically, and documented their omission from package function listings. ([#4473](https://github.com/BoundaryML/baml/pull/4473)) - Antonio Sarosi
