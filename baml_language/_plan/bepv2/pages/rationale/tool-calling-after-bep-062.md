# Tool Calling After BEP-062

> **Status:** Future design. This is not part of the current executable API.

This page describes how BEP-062 can simplify the BEPv2 tool API after its
function-value features land. Those features include the compiler-derived
`Function` interface, tuples, named tuples, spread/rest, and `reflect.call`.
...
- a hook may return a complete replacement roster containing new
  function-backed or MCP tools between steps; and
