...
> **Status:** Partial — the safe behavior works through a custom driver. A
> standard model-failure hook is still proposed.
...
This proposed interface has one required method, so the snippet shows the
complete policy rather than relying on an unseen base class.
...
- [Failure and replay model](../specification/09-reliability-and-errors.md)
