...
- [Exact persistence](../../pages/05-tools-and-agents.md#exact-persistence-and-restoration)
- [Resource tokens](../../pages/06-resources.md#crossing-processes-tokens)
- Scenarios 20 server chains, 40 harness sessions
