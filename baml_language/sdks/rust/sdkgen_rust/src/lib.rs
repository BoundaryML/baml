...
mod tests {
    ...
    fn closed_interface_throws_lower_to_concrete_error_union() {
        ...
        let implementors = HashMap::from([(
            failure,
            vec![
                Ty::Class(network, Vec::new().into(), baml_base::TyAttr::EMPTY),
                Ty::Class(tool, Vec::new().into(), baml_base::TyAttr::EMPTY),
            ],
        )]);
    ...
    #[test]
    fn unclosed_non_union_interface_throws_uses_runtime_fallback() {
        ...
        assert!(lib.contains("pubfncall("), "{lib}");
        assert!(lib.contains("Error<::core::convert::Infallible>"), "{lib}");
    }
    ...
    fn unrepresentable_nominal_throws_arms_use_runtime_fallback() {
        ...
        function.throws = Some(Ty::Union(
            vec![
                Ty::Class(typed.clone(), Vec::new().into(), baml_base::TyAttr::EMPTY),
                Ty::Class(opaque.clone(), Vec::new().into(), baml_base::TyAttr::EMPTY),
            ]
            .into(),
            baml_base::TyAttr::EMPTY,
        ));
