...
@typing.final
class BamlEncodedResult:
    @property
    def payload(self) -> bytes: ...
    def _wrap_handle(self, key: builtins.int, kind: builtins.int) -> BamlPyHandle: ...
...
@typing.final
class BamlPyHandle:
    def _sdk_concrete_name(self, bundle_id: typing.Sequence[builtins.int]) -> typing.Optional[builtins.str]:
        r"""
    ...
    def _key_for_call(self) -> builtins.int:
        ...
        """
    def _key_for_concrete_call(self) -> builtins.int:
        r"""
...
class BamlRuntime:
    ...
    def initialize_runtime_from_bytecode(bytecode: typing.Sequence[builtins.int], embedded_baml_toml: typing.Optional[builtins.str] = None) -> BamlRuntime:
        ...
        * `bytecode` - borsh-encoded BAML bytecode program
        """
    def cancel_function_call(self, call_id: builtins.int) -> builtins.bool:
        r"""
...
def _pending_transfer_count() -> builtins.int: ...
