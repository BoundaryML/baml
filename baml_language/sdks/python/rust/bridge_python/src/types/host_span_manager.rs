...
impl HostSpanManager {
    ...
    fn enter(&mut self, py: Python<'_>, name: String, args: Py<PyAny>) -> PyResult<()> {
...
// Tests for HostSpanManager internals live in bridge_cffi (no pyo3 dependency).
// The pyo3 wrapper is a thin delegation layer tested via the Python test suite.
