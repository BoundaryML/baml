...
internal sealed class MediaPayload : IEquatable<MediaPayload>
{
    ...
    internal ReadOnlyMemory<byte> Bytes =>
        bytes is null ? ReadOnlyMemory<byte>.Empty : new ReadOnlyMemory<byte>(bytes);
    ...
    internal static MediaPayload FromBase64(string base64, string mediaType)
    {
        ...
        ArgumentException.ThrowIfNullOrWhiteSpace(mediaType);
        if (base64.Length % 4 != 0 || base64.Any(char.IsWhiteSpace))
        {
            throw new FormatException("The media value is not canonical base64.");
        }

        int padding = base64.EndsWith("==", StringComparison.Ordinal)
            ? 2
            : base64.EndsWith('=') ? 1 : 0;
        long decodedLength = (long)(base64.Length / 4) * 3 - padding;
        BamlValueLimits.RequireBytes(decodedLength, "$.media", typeof(ReadOnlyMemory<byte>));
        return FromBytes(Convert.FromBase64String(base64), mediaType);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        BamlValueLimits.RequireBytes(stream.Length, "$.media", typeof(ReadOnlyMemory<byte>));
    ...
    public override bool Equals(object? obj) => Equals(obj as MediaPayload);
    ...
    public override string ToString()
    {
        ...
        string safe = sensitive < 0 ? url : $"{url[..sensitive]}?<redacted>";
...
public sealed class BamlImage : IEquatable<BamlImage>
{
    ...
    public static BamlImage FromBytes(ReadOnlyMemory<byte> data, string mediaType) =>
        new(MediaPayload.FromBytes(data, mediaType));

    public static BamlImage FromBase64(string base64, string mediaType) =>
    ...
    public static async Task<BamlImage> FromFileAsync(
        ...
        new(await MediaPayload.FromFileAsync(path, mediaType, cancellationToken).ConfigureAwait(false));
    ...
    public bool Equals(BamlImage? other) => other is not null && payload.Equals(other.payload);

    public override bool Equals(object? obj) => Equals(obj as BamlImage);

    public override int GetHashCode() => payload.GetHashCode();

    public override string ToString() => $"BamlImage({payload})";

    internal MediaPayload Payload => payload;

    internal static BamlImage FromPayload(MediaPayload payload) => new(payload);
}
...
public sealed class BamlAudio : IEquatable<BamlAudio>
{
    ...
    private BamlAudio(MediaPayload payload) => this.payload = payload;
    ...
    public static BamlAudio FromBytes(ReadOnlyMemory<byte> data, string mediaType) =>
        new(MediaPayload.FromBytes(data, mediaType));

    public static BamlAudio FromBase64(string base64, string mediaType) =>
        new(MediaPayload.FromBase64(base64, mediaType));
    ...
    public bool Equals(BamlAudio? other) => other is not null && payload.Equals(other.payload);

    public override bool Equals(object? obj) => Equals(obj as BamlAudio);
    ...
    internal static BamlAudio FromPayload(MediaPayload payload) => new(payload);
}
...
public sealed class BamlVideo : IEquatable<BamlVideo>
{
    ...
    private BamlVideo(MediaPayload payload) => this.payload = payload;
    ...
    public static BamlVideo FromBytes(ReadOnlyMemory<byte> data, string mediaType) =>
        new(MediaPayload.FromBytes(data, mediaType));

    public static BamlVideo FromBase64(string base64, string mediaType) =>
        new(MediaPayload.FromBase64(base64, mediaType));
    ...
    public bool Equals(BamlVideo? other) => other is not null && payload.Equals(other.payload);

    public override bool Equals(object? obj) => Equals(obj as BamlVideo);
    ...
    internal static BamlVideo FromPayload(MediaPayload payload) => new(payload);
}
...
public sealed class BamlPdf : IEquatable<BamlPdf>
{
    ...
    public static BamlPdf FromBytes(ReadOnlyMemory<byte> data, string mediaType = "application/pdf") =>
        new(MediaPayload.FromBytes(data, mediaType));

    public static BamlPdf FromBase64(string base64, string mediaType = "application/pdf") =>
        new(MediaPayload.FromBase64(base64, mediaType));
    ...
    public bool Equals(BamlPdf? other) => other is not null && payload.Equals(other.payload);

    public override bool Equals(object? obj) => Equals(obj as BamlPdf);
    ...
    internal static BamlPdf FromPayload(MediaPayload payload) => new(payload);
}
