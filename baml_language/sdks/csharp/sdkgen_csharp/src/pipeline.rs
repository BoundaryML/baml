...
use crate::{
    ...
    transaction::{GeneratedFile, GeneratedTree, GenerationMetadata},
};
...
mod tests {
    ...
    use baml_codegen_types::{Name, SymbolPool};
    ...
    use crate::{
        ...
        transaction::commit_generated_tree,
    };
    ...
    fn preparation_consumes_every_route_and_owns_bytecode_projection() {
        ...
        commit_generated_tree(root.path(), Path::new("baml_client"), &tree).unwrap();
