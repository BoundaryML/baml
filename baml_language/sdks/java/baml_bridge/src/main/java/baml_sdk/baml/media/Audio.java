...
/**
 * Runtime-owned {@code Audio} media handle (BAML stdlib path {@code baml.media}).
...
public final class Audio {
    ...
    private static UnsupportedOperationException notImplemented() {
        return new UnsupportedOperationException("capability not yet implemented: Audio media");
    }
}
