...
/**
 * Runtime-owned {@code Image} media handle (BAML stdlib path {@code baml.media}).
...
public final class Image {
    ...
    private static UnsupportedOperationException notImplemented() {
        return new UnsupportedOperationException("capability not yet implemented: Image media");
    }
}
