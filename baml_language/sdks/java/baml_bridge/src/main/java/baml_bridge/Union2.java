 ...
 * multi-arm BAML union of <em>2</em> arms renders as {@code Union2}, a
 ...
 * stripped). Every arm record declares <em>all</em> 2 type parameters and
 * wraps only its own positional arm's type, so Java&nbsp;21+ consumers get an
 * exhaustive {@code switch} with record patterns
 * (e.g. {@code case Union2.Arm0(var x) -> ...}); Java&nbsp;17 consumers use
