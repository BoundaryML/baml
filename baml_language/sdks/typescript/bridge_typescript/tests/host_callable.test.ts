...
//
// Registration retains the callable until engine GC/release, but no longer
// pins the event loop. callback_lifetime.test.ts verifies natural process exit,
// retained idle values, foreground work and background callback re-entry.
