  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '0.11.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.11.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
const { AbortController, BamlHandle, BamlRuntime, Collector, FunctionLog, HostSpanManager, LlmCall, LLMCall, Timing, Usage, _seedFunctionRefHandle, _seedGenericMediaHandle, completeHostCall, flushEvents, getRuntime, getVersion, handleClone, handleRelease, handleType, handleValidate, mediaBase64, mediaFile, mediaFromBase64, mediaFromFile, mediaFromUrl, mediaMimeType, mediaUrl, mediaValidate, putHandleIntoTable, registerHostCallable, releaseHostCallable, takeHandleFromTable } = nativeBinding
...
export { mediaBase64 }
export { mediaFile }
export { mediaFromBase64 }
export { mediaFromFile }
export { mediaFromUrl }
export { mediaMimeType }
export { mediaUrl }
export { mediaValidate }
export { putHandleIntoTable }
export { registerHostCallable }
export { releaseHostCallable }
export { takeHandleFromTable }
