...
#[test]
fn test_main_extract_resume_build_request_includes_openai_api_key() {
    use baml_sdk::lorem;
...
#[test]
fn test_main_streaming_extract_build_request_includes_openai_api_key() {
    use baml_sdk::lorem;
...
#[test]
fn test_main_classify_sentiment_build_request_includes_anthropic_api_key() {
    use baml_sdk::ipsum;
