...
class TestMain {
    ...
    @Test
    void test_namespaces_reachable_via_explicit_import() {
        assertNotNull(Resume.class);
        assertNotNull(Sentiment.class);
    }

    @Test
    void test_lorem_resume_class_shape() {
    ...
    @Test
    void test_lorem_streaming_doc_class_shape() {
        assertEquals(Set.of("title", "body", "word_count"), fieldNames(StreamingDoc.class));
    }

    @Test
    void test_ipsum_sentiment_enum_shape() {
    ...
    @Test
    void test_extract_resume_factory_bindings() {
    ...
    @Test
    void test_extract_resume_companion_bindings() {
    ...
    @Test
    void test_streaming_extract_factory_bindings() {
    ...
    @Test
    void test_streaming_extract_companion_bindings() {
        for (String name :
                List.of(
    ...
    @Test
    void test_classify_sentiment_factory_bindings() {
    ...
    @Test
    void test_replay_server_namespace_bindings() {
