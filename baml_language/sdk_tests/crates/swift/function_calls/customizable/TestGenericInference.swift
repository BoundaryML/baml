...
final class TestGenericInference: XCTestCase {
    ...
    func test_identity_async_infers() async throws {
        let r = try await G.identity_async(x: 7)
        XCTAssertEqual(r, 7)
    }

    func test_identity_null_round_trips() throws {
        let r: Int? = try G.identity(x: Int?.none)
        XCTAssertNil(r)
    }

    func test_make_triple_infers_multiple_typevars() throws {
    ...
    func test_second_of_infers_from_nested_generic() throws {
        XCTAssertEqual(
    ...
    func test_read_items_infers_from_instance() throws {
    ...
    func test_list_head_infers_from_recursive_generic() throws {
    ...
    func test_extract_infers_four_typevars() throws {
    ...
    func test_tag_or_value_null_binds_rust_type() throws {
        XCTAssertEqual(
    ...
    func test_pair_invariant_list_agree_binds() throws {
        XCTAssertEqual(try G.pair(a: [1, 2], b: [3, 4]), "int")
    }

    func test_glue_invariant_and_covariant_agree_binds() throws {
        XCTAssertEqual(try G.glue(bare: 1, arr: [2, 3]), "int")
    }

    func test_triple_choose_three_covariant_join() throws {
    ...
    func test_consume_int_wrapper_baseline() throws {
    ...
    func test_make_int_box_reified() throws {
        let box: G.GenericBox<Int> = try G.make_int_box()
        XCTAssertEqual(box.value, 7)
    }

    func test_make_int_container_reified() throws {
