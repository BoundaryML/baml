...
final class TestRecursion: XCTestCase {
    func test_round_trip_int_binary_tree() throws {
    ...
    func test_round_trip_mutual_recursion() throws {
    ...
    func test_round_trip_scc_t1_t2_t3() throws {
    ...
    func test_round_trip_scc_t4_t5_t6() throws {
