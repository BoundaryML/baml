...
final class TestGenerics: XCTestCase {
    ...
    func test_round_trip_generic_binary_tree_int() throws {
    ...
    func test_round_trip_box_int() throws {
    ...
    func test_round_trip_nested_generics() throws {
    ...
    func test_round_trip_differing_instantiation() throws {
