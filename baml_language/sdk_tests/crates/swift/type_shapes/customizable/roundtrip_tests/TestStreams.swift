...
final class TestStreams: XCTestCase {
    ...
    func test_round_trip_resume_or_resume_stream() throws {
    ...
    func test_round_trip_resume_or_http_response() throws {
