...
CheckNominal(
    ...
    "user.csharp_dynamic_values.DynamicColor",
    []);
...
CheckNominal(
    ...
    "user.csharp_dynamic_values.DynamicRecord",
    []);
...
CheckNominal(
    ...
    BamlValueKind.Class,
    BamlTypeDescriptorKind.Class,
    "user.csharp_dynamic_values.DynamicBox",
...
CheckNominal(
    ...
    BamlValueKind.Class,
    BamlTypeDescriptorKind.Class,
    "user.csharp_dynamic_values.DynamicEnvelope",
    []);
Check(
...
Console.WriteLine("csharp_dynamic_values=ok");
return 0;
