// TypeScript/Node-only coverage for structurally typed plain-object inputs.
...
describe("language-specific roundtrip complex_models", () => {
  it("test_round_trip_complex_profile_accepts_plain_object_literals", () => {
    ...
    const profile: ComplexProfile = {
      ...
      owner: {
        ...
        backup_contacts: [
          { label: "phone", value: "+1-555-0100", verified: false },
        ],
      },
      addresses: [
        {
