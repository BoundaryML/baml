...
describe("roundtrip unions", () => {
  ...
  it("test_round_trip_t", () => {
    const t = new T({ v: 4 });
    expect(round_trip_t(t)).toEqual(t);
  });
  it("test_round_trip_union_container", () => {
