...
describe("roundtrip literals", () => {
  ...
  it("test_round_trip_literal42", () =>
    expect(round_trip_literal42(42)).toBe(42));
  it("test_round_trip_literal_draft", () =>
    expect(round_trip_literal_draft("draft")).toBe("draft"));
  it("test_round_trip_literal_escaped", () =>
    expect(round_trip_literal_escaped('has "quotes"')).toBe('has "quotes"'));
  it("test_round_trip_literal_true", () =>
    expect(round_trip_literal_true(true)).toBe(true));
  it("test_round_trip_literal_false", () =>
    expect(round_trip_literal_false(false)).toBe(false));
  it("test_round_trip_literals", () => {
