...
import {
  Thing,
  round_trip_thing_from_ab,
  round_trip_root_foo_from_ab,
} from "./baml_sdk/a/b/index.js";
import {
  Resume,
  round_trip_resume,
  round_trip_root_foo,
...
describe("roundtrip routing", () => {
  ...
  it("test_round_trip_root_foo", () => {
    const f = new Foo({ v: 6 });
    expect(round_trip_root_foo(f)).toEqual(f);
  });
  it("test_round_trip_lorem_resume_from_ipsum", () => {
