...
describe("roundtrip generics", () => {
  ...
  it("test_round_trip_differing_instantiation", () => {
    const d = new DifferingInstantiation({
      list: new GenericLinkedList({
        value: new Wrapper({ value: 1 }),
        next: null,
      }),
    });
