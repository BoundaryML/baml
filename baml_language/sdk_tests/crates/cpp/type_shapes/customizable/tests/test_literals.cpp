...
BAML_TEST(return_literals) {
    ...
    BAML_ASSERT_EQ(baml_sdk::literals::return_literal_draft(), std::string("draft"));
    BAML_ASSERT_EQ(baml_sdk::literals::return_literal_escaped(), std::string("has \"quotes\""));
...
BAML_TEST(round_trip_literal_draft) {
    BAML_ASSERT_EQ(baml_sdk::literals::round_trip_literal_draft("draft"), std::string("draft"));
}

BAML_TEST(round_trip_literal_escaped) {
    BAML_ASSERT_EQ(baml_sdk::literals::round_trip_literal_escaped("has \"quotes\""),
