...
BAML_TEST(optional_args_runtime_matrix) {
    ...
    BAML_ASSERT(baml_sdk::optional_args_probe(
                    1, OptionalArgsProbeOpts{}.set_opt1(baml::unset).set_opt2(baml::unset)) ==
                (Probe{1, 5, 99}));
    BAML_ASSERT(baml_sdk::optional_args_probe(1, OptionalArgsProbeOpts{}.set_opt1(std::nullopt)) ==
                (Probe{1, std::nullopt, 99}));
    BAML_ASSERT(baml_sdk::optional_args_probe(1, OptionalArgsProbeOpts{}.set_opt1(int64_t{8})) ==
                (Probe{1, 8, 99}));
    BAML_ASSERT(baml_sdk::optional_args_probe(1, OptionalArgsProbeOpts{}.set_opt2(std::nullopt)) ==
                (Probe{1, 5, std::nullopt}));
    BAML_ASSERT(baml_sdk::optional_args_probe(1, OptionalArgsProbeOpts{}.set_opt2(int64_t{9})) ==
                (Probe{1, 5, 9}));
    BAML_ASSERT(baml_sdk::optional_args_probe(
                    1, OptionalArgsProbeOpts{}.set_opt1(std::nullopt).set_opt2(std::nullopt)) ==
                (Probe{1, std::nullopt, std::nullopt}));
    BAML_ASSERT(baml_sdk::optional_args_probe(
                    1, OptionalArgsProbeOpts{}.set_opt1(int64_t{8}).set_opt2(int64_t{9})) ==
                (Probe{1, 8, 9}));
}
...
BAML_TEST(unset_and_null_differ_in_one_call) {
    ...
    BAML_ASSERT(baml_sdk::optional_args_probe(
                    1, OptionalArgsProbeOpts{}.set_opt1(baml::unset).set_opt2(std::nullopt)) ==
                (Probe{1, 5, std::nullopt}));
    BAML_ASSERT(baml_sdk::optional_args_probe(
                    1, OptionalArgsProbeOpts{}.set_opt1(std::nullopt).set_opt2(baml::unset)) ==
                (Probe{1, std::nullopt, 99}));
}

BAML_TEST(optional_args_async_samples) {
    BAML_ASSERT(baml_sdk::optional_args_probe_async(1).get() == (Probe{1, 5, 99}));
    BAML_ASSERT(
        baml_sdk::optional_args_probe_async(1, OptionalArgsProbeOpts{}.set_opt1(std::nullopt))
            .get() == (Probe{1, std::nullopt, 99}));
    BAML_ASSERT(
        baml_sdk::optional_args_probe_async(1, OptionalArgsProbeOpts{}.set_opt2(int64_t{9}))
            .get() == (Probe{1, 5, 9}));
}
...
BAML_TEST(opt_box_method_matrix) {
    ...
    BAML_ASSERT(box2.probe(1, OptBox::ProbeOpts{}.set_opt1(int64_t{8})) == (Probe{10, 1, 8}));
}
