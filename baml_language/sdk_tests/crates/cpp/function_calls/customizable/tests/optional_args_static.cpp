...
constexpr auto probe_invocable(int)
    -> decltype(baml_sdk::optional_args_probe(std::declval<Args>()...), bool()) {
    return true;
}
template <typename...>
constexpr bool probe_invocable(...) {
    return false;
}
