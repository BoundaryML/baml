...
describe.runIf(isTestRuntime("node"))(
  "roundtrip media — decode path (return_*)",
  () => {
...
describe.runIf(isTestRuntime("node"))(
  "roundtrip media — encode path (round_trip_*)",
  () => {
    it("round_trip_image", () =>
      expect(round_trip_image(return_image(URL, null))).not.toBeNull());
    it("round_trip_audio", () =>
      expect(round_trip_audio(return_audio(URL, null))).not.toBeNull());
    it("round_trip_video", () =>
      expect(round_trip_video(return_video(URL, null))).not.toBeNull());
    it("round_trip_pdf", () =>
      expect(round_trip_pdf(return_pdf(URL, null))).not.toBeNull());
