...
def test_main_extract_resume_companion_bindings():
...
def test_main_streaming_extract_companion_bindings():
    from baml_sdk import lorem
...
def test_main_extract_resume_build_request_includes_openai_api_key(monkeypatch):
...
def test_main_streaming_extract_build_request_includes_openai_api_key(monkeypatch):
...
def test_main_classify_sentiment_build_request_includes_anthropic_api_key(monkeypatch):
