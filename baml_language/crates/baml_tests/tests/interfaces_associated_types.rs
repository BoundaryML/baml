...
fn associated_type_declaration_forms_compile() {
    assert_zero_compile_errors(
        ...
        interface Graph {
            ...
            function neighbors(self, node: Node) -> Node[] throws never
            function edge_label(self, edge: Edge) -> LabelType throws never
            function weight(self, edge: Edge) -> Weight throws never
        }
...
fn associated_type_bindings_substitute_inside_implements_blocks() {
    assert_zero_compile_errors(
        ...
        interface Stack {
            ...
            function push(self, value: Item) -> null throws never
            function peek(self) -> Self.Item? throws never
            function pair(self, value: Item) -> Self.Item[] throws never {
                return [value, value]
            }
        }
...
fn generic_constructor_result_checked_against_interface_associated_binding() {
    let errors = collect_compile_errors(
        ...
        interface Value {
            ...
            function get(self) -> Item throws never
        }
...
fn associated_type_projection_from_generic_interface_bound_compiles() {
    assert_zero_compile_errors(
        ...
        interface Parser {
            ...
            function parse(self, input: string) -> Output throws never
        }
...
fn qualified_typevar_projection_disambiguates_required_interfaces() {
    assert_zero_compile_errors(
        ...
        interface Reader {
            ...
            function read(self) -> Item throws never
        }
...
fn selected_projection_rejects_mismatched_associated_type_binding() {
    assert_compile_error_code(
        ...
        interface Codec<Format> {
            ...
            function decode(self, input: string) -> Output throws never
        }
...
fn generic_interface_associated_type_bindings_compile() {
    assert_zero_compile_errors(
        ...
        interface Cache<K> {
            ...
            function get(self, key: K) -> Value? throws never
            function put(self, key: K, value: Value) -> null throws never
        }
...
fn associated_type_default_can_reference_explicit_witness() {
    assert_zero_compile_errors(
        ...
        interface Batch {
            ...
            function all(self) -> Items throws never
        }
    ...
    assert_zero_compile_errors_multi(&[
        (
            ...
            interface Cache {
                ...
                function get(self) -> Value throws never
            }
            "#,
        ),
        (
    ...
    assert_zero_compile_errors_multi(&[
        (
            ...
            interface Serializable {
                ...
                function serialize(self) -> Format throws never
            }
...
fn dependent_associated_type_bound_uses_resolved_witness() {
    assert_zero_compile_errors(
        ...
        interface Parser {
            ...
            function parse(self) -> Output throws never
        }
...
fn associated_type_bindings_can_be_union_types() {
    assert_zero_compile_errors(
        ...
        interface Source {
            ...
            function get(self) -> Item throws never
            function maybe(self) -> Item? throws never
            function either(self) -> Item | bool throws never
        }
...
fn associated_type_union_defaults_can_reference_interface_generics() {
    assert_zero_compile_errors(
        ...
        interface Response<T> {
            ...
            function payload(self) -> Payload throws never
        }
...
fn associated_type_union_substitutes_inside_nested_containers() {
    assert_zero_compile_errors(
        ...
        interface Source {
            ...
            function list(self) -> Item[] throws never
            function table(self) -> map<string, Item | null> throws never
        }
...
fn out_of_body_implements_can_bind_associated_types() {
    assert_zero_compile_errors(
        ...
        interface Showable {
            ...
            function repr(self) -> Repr throws never
        }
...
fn associated_types_substitute_inside_nested_type_positions() {
    assert_zero_compile_errors(
        ...
        interface Mapper {
            ...
            function list(self) -> Item[] throws never
            function table(self) -> map<string, Item?> throws never
            function choose(self) -> Item? throws never
        }
...
fn associated_types_substitute_inside_function_type_positions() {
    assert_zero_compile_errors(
        ...
        interface Lifter {
            ...
            function lift(self) -> (Item) -> Item? throws never
        }
...
fn associated_union_required_method_impl_must_match_interface_signature() {
    assert_compile_error_contains(
        ...
        interface Producer {
            ...
            function produce(self) -> Item | string throws never
        }
...
async fn runtime_dispatch_substitutes_class_typevar_inside_nested_associated_binding() {
    let output = baml_test!(
        ...
        interface Outer {
            ...
            function inner(self) -> Inner throws never
        }
