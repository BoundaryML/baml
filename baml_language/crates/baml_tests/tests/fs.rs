...
async fn fs_open_and_read() {
    ...
    function main() -> string {
        ...
        load_const "r"
        schedule_future baml.fs.open
        await
        schedule_future baml.fs.File.text
        await
        return
    }
    "#);
...
async fn fs_open_and_read_bytes() {
    ...
    function main() -> uint8array {
        ...
        schedule_future baml.fs.open
        await
        schedule_future baml.fs.File.bytes
        await
        return
    }
    "#);
...
async fn fs_write_bytes() {
    ...
    function main() -> int {
        ...
        load_var data
        schedule_future baml.fs.write_bytes
        await
        return
    }
    "#);
...
async fn fs_file_rw_seek_and_read() {
    ...
    function main() -> string {
        ...
        load_const "start"
        load_const 6
        schedule_future baml.fs.File.seek_from
        await
        pop 1
        load_var file
        schedule_future baml.fs.File.text
...
async fn fs_file_rw_write_and_read_back() {
    ...
    function main() -> string {
        ...
        load_var file
        load_const "to Rust!!"
        schedule_future baml.fs.File.write
        await
        pop 1
        load_var file
        load_const "start"
...
async fn fs_file_rw_write_bytes() {
    ...
    function main() -> int {
        ...
        load_var file
        load_var bytes
        schedule_future baml.fs.File.write_bytes
        await
        return
    }
    "#);
...
async fn fs_exists_returns_true() {
    ...
    function main() -> bool {
        ...
        schedule_future baml.fs.exists
        await
        return
    }
    "#);
