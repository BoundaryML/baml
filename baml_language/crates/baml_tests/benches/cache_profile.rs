...
//!
//! Reads hardware performance counters (cycles, instructions, L1 I/D-cache
//! misses, branch mispredictions) around VM workloads.
//!
//! Outputs both human-readable tables and a JSON results file for A/B comparison.
//!
//! Requires: sudo
//!
//! Usage:
