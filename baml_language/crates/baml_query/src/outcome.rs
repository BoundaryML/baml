...
use crate::{error::QueryError, scope::Snapshot};
...
impl QueryOutcome {
    ...
    pub fn ended(
        ...
        let result_state = match error.code {
            QueryErrorCode::BudgetExceeded => ResultState::BudgetExhausted,
            QueryErrorCode::Cancelled => ResultState::Cancelled,
