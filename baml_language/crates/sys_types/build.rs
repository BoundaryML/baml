...
fn main() {
    ...
    baml_rustgen_check::assert_generated_matches_baml_std("sys_types/src/io_generated.rs");
    baml_rustgen_check::assert_generated_matches_baml_std("sys_types/src/runtime_io.rs");
}
