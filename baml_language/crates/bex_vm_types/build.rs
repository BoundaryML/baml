...
fn main() {
    ...
    baml_rustgen_check::assert_generated_matches_baml_std("bex_vm_types/src/sys_op_generated.rs");
    baml_rustgen_check::assert_generated_matches_baml_std("bex_vm_types/src/errors_generated.rs");
    baml_rustgen_check::assert_generated_matches_baml_std("bex_vm_types/src/panics_generated.rs");
}
