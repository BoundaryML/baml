...
impl BamlClassTimePlainDate for PackageBamlImpl {
    ...
    fn to_string(plaindate: &view::time::PlainDate<'_>) -> Result<bex_str::BexStr, VmRustFnError> {
    ...
    fn to_plain_datetime(vm: &mut BexVm, plaindate: &Value, time: Option<&Value>) -> Value {
        let days = {
            let instance = vm
...
impl BamlClassTimePlainTime for PackageBamlImpl {
    ...
    fn to_string(plaintime: &view::time::PlainTime<'_>) -> bex_str::BexStr {
