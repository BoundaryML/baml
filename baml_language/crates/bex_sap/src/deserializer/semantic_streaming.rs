...
// // use baml_types::{BamlValueWithMeta, Completion, ResponseCheck, TypeValue};
// use crate::jsonish::CompletionState;
// use crate::sap_model::AnnotatedTy;
...
//     let typed_baml_value: BamlValueWithMeta<(Vec<Flag>, AnnotatedTy)> =
...
//         0,
//         mode == crate::StreamingMode::NonStreaming,
//     )?;
//     Ok(top_level_node)
// }
...
// fn process_node(
//     ir: &impl IRHelperExtended,
//     value: BamlValueWithMeta<(CompletionState, &AnnotatedTy)>,
//     _depth: usize,
...
//             // these nulls here.
//             let mut deletion_nulls: IndexMap<String, BamlValueWithMeta<Completion>> = IndexMap::new();
...
// fn type_field_names(ir: &impl IRHelperExtended, field_type: &AnnotatedTy) -> IndexSet<String> {
//     match field_type {
//         AnnotatedTy::Class {
//             name: class_name, ..
...
//             TypeValue::Null => true,
//         },
//         AnnotatedTy::Literal { .. } => true,
//         AnnotatedTy::List(_, _) => false,
//         AnnotatedTy::Map(_, _, _) => false,
//         AnnotatedTy::Enum {
//             name: _,
//             dynamic: _,
//             meta: _,
//         } => true,
//         AnnotatedTy::Tuple(_, _) => false,
//         AnnotatedTy::RecursiveTypeAlias { .. } => false,
//         AnnotatedTy::Class { .. } => false,
//         AnnotatedTy::Union(options, _) => {
...
//             })
//         }
//         AnnotatedTy::Arrow(_, _) => false, // TODO: Error? Arrow shouldn't appear here.
//         AnnotatedTy::Top(_) => panic!(
//             "AnnotatedTy::Top should have been resolved by the compiler before code generation. \
...
//             AnnotatedTy::Primitive(TypeValue::Null, TypeMeta::default()),
...
//             value: s.to_string(),
//             target: AnnotatedTy::Primitive(TypeValue::String, TypeMeta::default()),
...
//             value: s,
//             target: AnnotatedTy::Primitive(TypeValue::Float, TypeMeta::default()),
//             flags: DeserializerConditions::default(),
//         })
//     }
...
//                 DeserializerConditions::default(),
//                 AnnotatedTy::recursive_type_alias("A").as_list(),
//                 items,
//             )
//         }
...
//         let res =
//             validate_streaming_state(&ir, &value, crate::StreamingMode::NonStreaming).unwrap();
...
//             .collect(),
//         );
//         let field_type = AnnotatedTy::class("Info");
