...
impl PrintMultiLine for ForCStyleArgs {
    ...
    fn print_multi_line(&self, shape: Shape, printer: &mut Printer) -> PrintInfo {
        ...
        printer.print_trivia_squished(cond_trailing);
        let (semi_leading, semi_trailing) =
            printer.trivia.get_for_range_split(self.semicolon.span());
        printer.print_trivia_squished(semi_leading);
...
pub(crate) trait ForCStyleArgsFormatExt {
    fn try_print_single_line(&self, shape: &Shape, printer: &mut Printer) -> Option<PrintInfo>;
}
impl ForCStyleArgsFormatExt for ForCStyleArgs {
    fn try_print_single_line(&self, shape: &Shape, printer: &mut Printer) -> Option<PrintInfo> {
        printer.print_raw_token(&self.open_paren);
...
pub(crate) trait ForIteratorArgsFormatExt {
    fn try_print_single_line(&self, shape: &Shape, printer: &mut Printer) -> Option<PrintInfo>;
}
impl ForIteratorArgsFormatExt for ForIteratorArgs {
    fn try_print_single_line(&self, shape: &Shape, printer: &mut Printer) -> Option<PrintInfo> {
        if let Some(open_paren) = &self.open_paren {
            printer.print_raw_token(open_paren);
