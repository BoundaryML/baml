...
// Re-export typing context builders from baml_thir for backward compatibility.
// These functions are now properly defined in baml_thir where they belong,
// as they produce THIR-level types (Ty<'db>).
pub use baml_thir::{build_class_fields_from_files, build_typing_context_from_files};
