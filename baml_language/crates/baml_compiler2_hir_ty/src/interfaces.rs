...
//! transitive `requires` closure, and associated-type binding lowering.
//!
//! Nominal interface membership uses the shared [`crate::impls`] registry.
...
use baml_type::{
    ParamTy, QualifiedTypeName, Ty, TyAttr, pattern_overlap::TypeVarBoundsMap, unify::TypeBindings,
};
pub use coherence::*;
pub use impl_rules::*;
