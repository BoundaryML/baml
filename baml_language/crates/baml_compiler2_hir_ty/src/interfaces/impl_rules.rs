...
use super::{
    ...
    lower_interface_associated_bindings, lower_ref_in, lower_ref_in_at,
...
pub fn validate_impl_signatures<'db>(
    ...
    // `requires`. ──
    {
        ...
        for &required_ref in &iface_data.requires {
            ...
            if !crate::impls::implements_interface_with_bounds(
                db,
                &for_ty,
                &required_iface,
                |a, b| baml_type::normalize::is_subtype(a, b, &ctx),
            ) {
                diags.push((
