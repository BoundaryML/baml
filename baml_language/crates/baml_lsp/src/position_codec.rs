...
impl From<PositionCodecError> for crate::error::LspError {
    fn from(e: PositionCodecError) -> Self {
        crate::error::LspError::InvalidParams(e.to_string())
    }
}
...
impl<'a> PositionCodec<'a> {
    ...
    pub fn byte_range_to_lsp(&self, range: TextRange) -> lsp_types::Range {
        lsp_types::Range {
    ...
    pub fn token_segments(&self, range: TextRange) -> Vec<TokenSegment> {
