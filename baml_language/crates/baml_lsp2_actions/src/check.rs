...
fn resolve_interface_path<'db>(
    ...
    let resolved = baml_compiler2_hir_ty::interfaces::resolve_path_to_interface_identity(
        db,
        target,
        pkg_items,
        namespace_path,
...
fn resolve_interface_ref<'db>(
    ...
    let resolved = baml_compiler2_hir_ty::interfaces::resolve_ref_to_interface_identity(
        db,
        store,
        target,
        pkg_items,
