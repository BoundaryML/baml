...
/// repository (e.g., test fixtures in `crates/lsp_actions_tests/`) to be treated as
...
mod tests {
    ...
    fn test_find_top_level_parent_baml_language_nested() {
        ...
        let path = PathBuf::from(
            "/home/user/baml_language/crates/lsp_actions_tests/test_files/syntax/class/valid.baml",
        );
        let result = find_top_level_parent(&path);
        assert_eq!(
            result,
