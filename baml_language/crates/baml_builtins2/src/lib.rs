...
pub const ALL: &[BuiltinFile] = &[
    ...
    builtin!("baml", "ns_ai/anthropic.baml"),
    builtin!("baml", "ns_ai/gemini.baml"),
    builtin!("baml", "ns_ai/combinators.baml"),
    builtin!("baml", "ns_ai/tools.baml"),
    builtin!("baml", "ns_ai/realtime.baml"),
    builtin!("baml", "ns_ai/stateful.baml"),
    builtin!("baml", "ns_ai/negotiation.baml"),
    builtin!("baml", "ns_ai/openai_responses.baml"),
    builtin!("baml", "ns_ai/openai_strict.baml"),
    builtin!("baml", "ns_ai/harness.baml"),
