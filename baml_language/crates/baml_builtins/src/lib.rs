...
//! # Builtin Generation
//!
//! Builtin metadata is generated at build time from `legacy_projection.dsl`
//! and included into this crate. Downstream runtime crates consume the
//! generated macros exported here rather than depending on proc macros.
