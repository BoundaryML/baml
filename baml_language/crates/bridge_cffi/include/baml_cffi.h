...
enum BamlCffiHandleType
...
#endif // __cplusplus
 {
  ...
  BAML_CFFI_HANDLE_TYPE_FUNCTION_SPEC = 17,
  BAML_CFFI_HANDLE_TYPE_RUNTIME_VALUE = 18,
  BAML_CFFI_HANDLE_TYPE_CONCRETE_OBJECT = 21,
  BAML_CFFI_HANDLE_TYPE_INTERFACE = 19,
  BAML_CFFI_HANDLE_TYPE_HOST_REFERENCE = 20,
};
#ifndef __cplusplus
