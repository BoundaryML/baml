...
use lsp_types::{
    self as types, ConfigurationParams, PublishDiagnosticsParams, notification as notif,
    request::Request,
};

use crate::{
    baml_project::Project,
    // TODO: common_version_up_to_patch is commented out since generators are disabled
    // baml_project::{Project, common_version_up_to_patch},
    server::{
        Result, Task,
        api::{
            self, ResultExt,
...
// TODO: BackgroundDocumentNotificationHandler is disabled for now since generators are disabled
