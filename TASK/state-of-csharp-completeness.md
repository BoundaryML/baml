...
| One atomic eight-RID `baml-bridge` package | blocked | `TASK/package-feasibility-evidence.md`: exact 200,000,000-byte ceiling, deterministic `0644` normalizer, one current local Linux x64 package execution, and untriggered all-eight workflow in `TASK/csharp-entry-gates-handoff.md`; real artifacts/runners remain | release; Q10 feasibility |
