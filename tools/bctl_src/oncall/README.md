...
- `bctl oncall notify [--post-to-slack]`
	...
	- schedules Slack reminders in the handoff thread to put the release out at the next 9am and 12pm Pacific (i.e. Friday morning when run Thursday afternoon)
