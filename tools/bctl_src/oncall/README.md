...
- `bctl oncall notify [--post-to-slack]`
	...
	- runs weekly Thursday 4pm Pacific, including daylight saving changes; reminders whose time has already passed (e.g. a manual run on Friday afternoon) are skipped
