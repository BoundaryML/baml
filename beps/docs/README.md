...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="./proposals/BEP-009-filesystem-api/"><strong>BEP-009</strong>: Filesystem API</a> &nbsp; <img src="https://img.shields.io/badge/Status-Proposed-yellow" alt="Proposed"><br><br>Extend BAML's `baml.fs` namespace with write operations, random-access I/O, and Bun-style naming. This is a breaking change that renames existing methods.<br><br><span style='font-size:0.8em; color:gray'>Shepherd(s): Antonio Sarosi <sarosiantonio@gmail.com></span></td>
    </tr>
  </tbody>
</table>
