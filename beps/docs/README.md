...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="./proposals/BEP-002-match/"><strong>BEP-002</strong>: match</a> &nbsp; <img src="https://img.shields.io/badge/Status-Accepted-brightgreen" alt="Accepted"><br><br><br><br><span style='font-size:0.8em; color:gray'>Shepherd(s): hellovai <vbv@boundaryml.com> | Created: 2025-12-01 | Updated: 2025-12-01</span></td>
    </tr>
  </tbody>
</table>
