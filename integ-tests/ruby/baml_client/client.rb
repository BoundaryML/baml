  ...
  class BamlSyncClient
      ...
      def TestFallbackAlwaysFails(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestFallbackAlwaysFails may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "TestFallbackAlwaysFails", args: {
              input: input,
          })
  ...
  class BamlStreamClient
      ...
      def TestFallbackAlwaysFails(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "TestFallbackAlwaysFails", args: {
              input: input,
          })
