  ...
  class BamlSyncClient
      ...
      def TestAzureEntraId(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestAzureEntraId may only be called with keyword arguments")
          end

          __options__ = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          __result__ = __options__.call_function_sync(function_name: "TestAzureEntraId", args: {
              input: input,
          })
      ...
      def TestAzureEntraIdSystemDefault(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestAzureEntraIdSystemDefault may only be called with keyword arguments")
          end

          __options__ = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          __result__ = __options__.call_function_sync(function_name: "TestAzureEntraIdSystemDefault", args: {
              input: input,
          })
  ...
  class BamlStreamClient
      ...
      def TestAzureEntraId(
          *varargs,
          ...
          __ctx__, __result__ = __options__.create_sync_stream(function_name: "TestAzureEntraId", args: {
              input: input,
          })
      ...
      def TestAzureEntraIdSystemDefault(
          *varargs,
          ...
          __ctx__, __result__ = __options__.create_sync_stream(function_name: "TestAzureEntraIdSystemDefault", args: {
              input: input,
          })
