...
/**
 * Executes the "TestSkipDynamic" BAML action.
 *
 * This server action calls the underlying BAML function "TestSkipDynamic"
 * with the specified parameters.
 *
 * @param { string } input - Input parameter.
 *
 * @returns {Promise<types.SkipDynamicClass>} A promise that resolves with the result of the action.
 */
export const TestSkipDynamic = async (
  input: string,
): Promise<types.SkipDynamicClass> => {
  return b.TestSkipDynamic(
    input,
  );
};

/**
 * Executes the "TestSkipNonDynamic" BAML action.
 *
 * This server action calls the underlying BAML function "TestSkipNonDynamic"
 * with the specified parameters.
 *
 * @param { string } input - Input parameter.
 *
 * @returns {Promise<types.SkipNonDynamicClass>} A promise that resolves with the result of the action.
 */
export const TestSkipNonDynamic = async (
  input: string,
): Promise<types.SkipNonDynamicClass> => {
  return b.TestSkipNonDynamic(
    input,
  );
};
