...
/**
 * Executes the "ExtractPersonWithMeta" BAML action.
 *
 * This server action calls the underlying BAML function "ExtractPersonWithMeta"
 * with the specified parameters.
 *
 * @param { string } input - Input parameter.
 *
 * @returns {Promise<types.PersonWithMeta>} A promise that resolves with the result of the action.
 */
export const ExtractPersonWithMeta = async (
  input: string,
): Promise<types.PersonWithMeta> => {
  return b.ExtractPersonWithMeta(
    input,
  );
};
