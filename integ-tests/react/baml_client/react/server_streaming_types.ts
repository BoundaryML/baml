...
export type StreamingServerTypes = {
  ...
  AllowedOptionalsExprFunc: OptionalListAndMap | null,
  ...
  ExtractPersonWithMeta: PersonWithMeta,
  ...
  FnLiteralClassInputOutputExprFunc: LiteralClassHello | null,
  FnLiteralUnionClassInputOutput: LiteralClassOne | LiteralClassTwo,
  FnLiteralUnionClassInputOutputExprFunc: LiteralClassOne | LiteralClassTwo | null,
  ...
  FnOutputClassExprFunc: TestOutputClass | null,
  FnOutputClassList: TestOutputClass[],
  FnOutputClassListExprFunc: TestOutputClass[],
  FnOutputClassNested: TestClassNested,
  FnOutputClassNestedExprFunc: TestClassNested | null,
  ...
  NullLiteralClassHelloExprFunc: ClassForNullLiteral | null,
  ...
  TestAzure: string,
  TestAzureEntraId: string,
  TestAzureEntraIdSystemDefault: string,
  ...
  TestFnNamedArgsSingleMapStringToClassExprFunc: Record<string, StringToClassEntry>,
  ...
  TestSkipDynamic: SkipDynamicClass,
  TestSkipNonDynamic: SkipNonDynamicClass,
