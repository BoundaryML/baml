...
// Build HTTP request for TestOpenAITranscription (returns baml.HTTPRequest)
func (*build_request) TestOpenAITranscription(audio types.Audio, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
...
// Build HTTP request for TestOpenAITranscriptionMultipartChat (returns baml.HTTPRequest)
func (*build_request) TestOpenAITranscriptionMultipartChat(audio types.Audio, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
...
// Build HTTP request for TestVertexClaudeGlobal (returns baml.HTTPRequest)
func (*build_request) TestVertexClaudeGlobal(input string, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
