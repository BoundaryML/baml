...
func TestAwsCaching(ctx context.Context, input string, not_cached string, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestAwsCaching", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAwsCaching", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
...
func TestOpenAITranscription(ctx context.Context, audio types.Audio, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestOpenAITranscription", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestOpenAITranscription", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
...
func TestOpenAITranscriptionMultipartChat(ctx context.Context, audio types.Audio, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestOpenAITranscriptionMultipartChat", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestOpenAITranscriptionMultipartChat", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
...
func TestVertexClaudeGlobal(ctx context.Context, input string, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestVertexClaudeGlobal", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestVertexClaudeGlobal", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
