...
func TestAzureEntraId(ctx context.Context, input string, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestAzureEntraId", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAzureEntraId", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
...
func TestAzureEntraIdSystemDefault(ctx context.Context, input string, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestAzureEntraIdSystemDefault", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAzureEntraIdSystemDefault", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
