...
func TestFallbackAlwaysFails(ctx context.Context, input string, opts ...CallOptionFunc) (string, error) {
	...
	if callOpts.onTick == nil {
		result, err := bamlRuntime.CallFunction(ctx, "TestFallbackAlwaysFails", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
		...
		channel, err := bamlRuntime.CallFunctionStream(ctx, "TestFallbackAlwaysFails", encoded, callOpts.onTick)
		if err != nil {
			return "", err
		}
