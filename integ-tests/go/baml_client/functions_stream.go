...
// / Streaming version of TestAzureEntraId
func (*stream) TestAzureEntraId(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAzureEntraId", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
...
// / Streaming version of TestAzureEntraIdSystemDefault
func (*stream) TestAzureEntraIdSystemDefault(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAzureEntraIdSystemDefault", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
