...
// / Streaming version of TestAwsCaching
func (*stream) TestAwsCaching(ctx context.Context, input string, not_cached string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestAwsCaching", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
...
// / Streaming version of TestDefaultStreamingTimeout
func (*stream) TestDefaultStreamingTimeout(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestDefaultStreamingTimeout", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
...
// / Streaming version of TestOpenAITranscription
func (*stream) TestOpenAITranscription(ctx context.Context, audio types.Audio, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestOpenAITranscription", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
...
// / Streaming version of TestOpenAITranscriptionMultipartChat
func (*stream) TestOpenAITranscriptionMultipartChat(ctx context.Context, audio types.Audio, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestOpenAITranscriptionMultipartChat", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
...
// / Streaming version of TestSkipDynamic
func (*stream) TestSkipDynamic(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[stream_types.SkipDynamicClass, types.SkipDynamicClass], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestSkipDynamic", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}

	channel := make(chan StreamValue[stream_types.SkipDynamicClass, types.SkipDynamicClass])
	go func() {
		for result := range internal_channel {
			if result.Error != nil {
				channel <- StreamValue[stream_types.SkipDynamicClass, types.SkipDynamicClass]{
					IsError: true,
					Error:   result.Error,
				}
				close(channel)
			...
			if result.HasData {
				data := (result.Data).(types.SkipDynamicClass)
				channel <- StreamValue[stream_types.SkipDynamicClass, types.SkipDynamicClass]{
					IsFinal:  true,
					as_final: &data,
				}
			} else {
				data := (result.StreamData).(stream_types.SkipDynamicClass)
				channel <- StreamValue[stream_types.SkipDynamicClass, types.SkipDynamicClass]{
					IsFinal:   false,
					as_stream: &data,
				}
...
// / Streaming version of TestSkipNonDynamic
func (*stream) TestSkipNonDynamic(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[stream_types.SkipNonDynamicClass, types.SkipNonDynamicClass], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestSkipNonDynamic", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}

	channel := make(chan StreamValue[stream_types.SkipNonDynamicClass, types.SkipNonDynamicClass])
	go func() {
		for result := range internal_channel {
			if result.Error != nil {
				channel <- StreamValue[stream_types.SkipNonDynamicClass, types.SkipNonDynamicClass]{
					IsError: true,
					Error:   result.Error,
				}
				close(channel)
			...
			if result.HasData {
				data := (result.Data).(types.SkipNonDynamicClass)
				channel <- StreamValue[stream_types.SkipNonDynamicClass, types.SkipNonDynamicClass]{
					IsFinal:  true,
					as_final: &data,
				}
			} else {
				data := (result.StreamData).(stream_types.SkipNonDynamicClass)
				channel <- StreamValue[stream_types.SkipNonDynamicClass, types.SkipNonDynamicClass]{
					IsFinal:   false,
					as_stream: &data,
				}
...
// / Streaming version of TestVertexClaudeGlobal
func (*stream) TestVertexClaudeGlobal(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestVertexClaudeGlobal", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
