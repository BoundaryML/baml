...
// / Streaming version of TestFallbackAlwaysFails
func (*stream) TestFallbackAlwaysFails(ctx context.Context, input string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	internal_channel, err := bamlRuntime.CallFunctionStream(ctx, "TestFallbackAlwaysFails", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
