...
describe('Expose Request Tests', () => {
  it('should expose request gpt4', async () => {
    const request = await b.request.ExtractReceiptInfo("test@email.com", "curiosity")
  ...
  it('should expose request gpt4 sync', () => {
    ...
    const request = b_sync.request.ExtractReceiptInfo("test@email.com", "curiosity")
  ...
  it('should expose request gpt4 stream', async () => {
    const request = await b.streamRequest.ExtractReceiptInfo("test@email.com", "curiosity")
  ...
  it('should expose request gpt4 stream sync', () => {
    ...
    const request = b_sync.streamRequest.ExtractReceiptInfo("test@email.com", "curiosity")
