...
export class BamlClient {
  ...
  async Brits(
    ...
    return raw.parsed() as ActorSubject
  }
...
class BamlStreamClient {
  ...
  Brits(
      input: string,
      __baml_options__?: { tb?: TypeBuilder }
  ): BamlStream<RecursivePartialNull<ActorSubject>, ActorSubject> {
    const raw = this.runtime.streamFunction(
      "Brits",
      {
        "input": input
    ...
    return new BamlStream<RecursivePartialNull<ActorSubject>, ActorSubject>(
      raw,
      (a): a is RecursivePartialNull<ActorSubject> => a,
      (a): a is ActorSubject => a,
      this.ctx_manager.cloneContext(),
      __baml_options__?.tb?.__tb(),
    )
  }
