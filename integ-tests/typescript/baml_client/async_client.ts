...
export class BamlAsyncClient {
  ...
  async PredictAgeComplex(
      inp: InputWithConstraint,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): Promise<InputWithConstraint> {
    try {
      const raw = await this.runtime.callFunction(
        "PredictAgeComplex",
        {
      ...
      return raw.parsed() as InputWithConstraint
    } catch (error: any) {
      const bamlError = createBamlValidationError(error);
      if (bamlError instanceof BamlValidationError) {
        throw bamlError;
...
class BamlStreamClient {
  ...
  PredictAgeComplex(
      inp: InputWithConstraint,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<InputWithConstraint>, InputWithConstraint> {
    try {
      const raw = this.runtime.streamFunction(
        "PredictAgeComplex",
        {
      ...
      return new BamlStream<RecursivePartialNull<InputWithConstraint>, InputWithConstraint>(
        raw,
        (a): a is RecursivePartialNull<InputWithConstraint> => a,
        (a): a is InputWithConstraint => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
