...
class BamlAsyncClient:
    ...
    async def MakeFoo(self, subject: str,from_email: str,body: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Foo:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="MakeFoo", args={
...
class BamlStreamClient:
    ...
    def MakeFoo(self, subject: str,from_email: str,body: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Foo, types.Foo]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="MakeFoo", args={
            "subject": subject,"from_email": from_email,"body": body,
        })
        return baml_py.BamlStream[stream_types.Foo, types.Foo](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def MakeFoo(self, subject: str,from_email: str,body: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="MakeFoo", args={
            "subject": subject,"from_email": from_email,"body": body,
        }, mode="request")
        return __result__
