...
# Impl: default_config
# Client: GPT35
# An implementation of V2_TestFnNamedArgsSingleInt.
...
async def default_config(*, myInt: int) -> str:
    response = await GPT35.run_jinja_template(
        ...
        args=dict(myInt=myInt)
    )
    deserialized = __deserializer.from_string(response.generated)
    return deserialized


def default_config_stream(*, myInt: int
) -> AsyncStream[str, str]:
...
BAMLV2_TestFnNamedArgsSingleInt.register_impl("default_config")(default_config, default_config_stream)