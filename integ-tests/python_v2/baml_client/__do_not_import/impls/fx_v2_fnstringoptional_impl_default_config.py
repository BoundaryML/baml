...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnStringOptional.
...
async def default_config(*, input: Optional[str] = None) -> str:
...
def default_config_stream(*, input: Optional[str] = None
) -> AsyncStream[str, str]:
...
BAMLV2_FnStringOptional.register_impl("default_config")(default_config, default_config_stream)