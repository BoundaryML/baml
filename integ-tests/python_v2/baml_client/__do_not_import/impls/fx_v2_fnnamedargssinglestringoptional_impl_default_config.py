...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnNamedArgsSingleStringOptional.
...
async def default_config(*, myString: Optional[str] = None) -> str:
...
def default_config_stream(*, myString: Optional[str] = None
) -> AsyncStream[str, str]:
...
BAMLV2_FnNamedArgsSingleStringOptional.register_impl("default_config")(default_config, default_config_stream)