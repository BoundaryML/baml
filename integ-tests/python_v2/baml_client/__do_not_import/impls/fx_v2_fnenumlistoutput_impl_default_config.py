...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnEnumListOutput.
...
async def default_config(*, input: str) -> List[EnumOutput]:
...
BAMLV2_FnEnumListOutput.register_impl("default_config")(default_config, default_config_stream)