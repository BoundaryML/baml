...
# Impl: default_config
# Client: GPT35
# An implementation of V2_TestFnNamedArgsSingleBool.
...
async def default_config(*, myBool: bool) -> str:
    response = await GPT35.run_jinja_template(
        ...
        args=dict(myBool=myBool)
    )
    deserialized = __deserializer.from_string(response.generated)
    return deserialized


def default_config_stream(*, myBool: bool
) -> AsyncStream[str, str]:
...
BAMLV2_TestFnNamedArgsSingleBool.register_impl("default_config")(default_config, default_config_stream)