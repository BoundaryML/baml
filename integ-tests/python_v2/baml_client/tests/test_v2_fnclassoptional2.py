...
from ..baml_types import ClassOptionalFieldsv2, IV2_FnClassOptional2, IV2_FnClassOptional2Stream
...
@baml.V2_FnClassOptional2.test(stream=True)
async def test_intermediate_olive(V2_FnClassOptional2Impl: IV2_FnClassOptional2Stream, baml_ipc_channel: BaseIPCChannel):
