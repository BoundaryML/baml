...
from ..baml_types import IFnTestClassAlias, IFnTestClassAliasStream, TestClassAlias
...
async def test_willing_brown(FnTestClassAliasImpl: IFnTestClassAliasStream, baml_ipc_channel: BaseIPCChannel):
    ...
    async with FnTestClassAliasImpl(param) as stream:
