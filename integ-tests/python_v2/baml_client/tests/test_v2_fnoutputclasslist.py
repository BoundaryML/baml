...
from ..baml_types import IV2_FnOutputClassList, IV2_FnOutputClassListStream, TestOutputClass
...
async def test_deep_scarlet(V2_FnOutputClassListImpl: IV2_FnOutputClassListStream, baml_ipc_channel: BaseIPCChannel):
