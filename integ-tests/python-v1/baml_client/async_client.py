...
class BamlAsyncClient:
    ...
    async def TestOpenAIShorthand(self, input: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def TestOpenAITranscription(self, audio: baml_py.Audio,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="TestOpenAITranscription", args={
                "audio": audio,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def TestOpenAITranscriptionMultipartChat(self, audio: baml_py.Audio,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="TestOpenAITranscriptionMultipartChat", args={
                "audio": audio,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    ...
    async def TestVertexClaude(self, input: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def TestVertexClaudeGlobal(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="TestVertexClaudeGlobal", args={
                "input": input,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def TestOpenAITranscription(self, audio: baml_py.Audio,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="TestOpenAITranscription", args={
            "audio": audio,
        })
        return baml_py.BamlStream[str, str](
          __result__,
    ...
    def TestOpenAITranscriptionMultipartChat(self, audio: baml_py.Audio,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="TestOpenAITranscriptionMultipartChat", args={
            "audio": audio,
        })
        return baml_py.BamlStream[str, str](
          __result__,
    ...
    def TestVertexClaudeGlobal(self, input: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="TestVertexClaudeGlobal", args={
            "input": input,
        })
        return baml_py.BamlStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def TestOpenAITranscription(self, audio: baml_py.Audio,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestOpenAITranscription", args={
            "audio": audio,
        }, mode="request")
        return __result__
    async def TestOpenAITranscriptionMultipartChat(self, audio: baml_py.Audio,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestOpenAITranscriptionMultipartChat", args={
            "audio": audio,
        }, mode="request")
        return __result__
    async def TestOpenAIWithFinishReasonError(self, input: str,
    ...
    async def TestVertexClaudeGlobal(self, input: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestVertexClaudeGlobal", args={
            "input": input,
        }, mode="request")
        return __result__
    async def TestVertexWithSystemInstructions(self, 
