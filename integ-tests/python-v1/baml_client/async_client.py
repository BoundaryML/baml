...
class BamlAsyncClient:
    ...
    async def ValidateResponseTypes(self, input: str,
        ...
        return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def VideoInput(self, vid: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> str:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="VideoInput", args={
            "vid": vid,
        })
        return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def VideoInputAnthropic(self, vid: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> str:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="VideoInputAnthropic", args={
            "vid": vid,
        })
        return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def VideoInputOpenai(self, vid: baml_py.Image,prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="VideoInputOpenai", args={
...
class BamlStreamClient:
    ...
    def VideoInput(self, vid: baml_py.Image,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="VideoInput", args={
            "vid": vid,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def VideoInputAnthropic(self, vid: baml_py.Image,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="VideoInputAnthropic", args={
            "vid": vid,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def VideoInputOpenai(self, vid: baml_py.Image,prompt: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="VideoInputOpenai", args={
            "vid": vid,"prompt": prompt,
        })
        return baml_py.BamlStream[str, str](
          result,
...
class BamlHttpRequestClient:
    ...
    async def VideoInput(self, vid: baml_py.Image,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="VideoInput", args={
            "vid": vid,
        }, mode="request")
        return result
    async def VideoInputAnthropic(self, vid: baml_py.Image,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="VideoInputAnthropic", args={
            "vid": vid,
        }, mode="request")
        return result
    async def VideoInputOpenai(self, vid: baml_py.Image,prompt: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="VideoInputOpenai", args={
            "vid": vid,"prompt": prompt,
        }, mode="request")
        return result
