...
class BamlAsyncClient:
    ...
    async def TestAws(self, input: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def TestAwsCaching(self, input: str,not_cached: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="TestAwsCaching", args={
...
class BamlStreamClient:
    ...
    def TestAwsCaching(self, input: str,not_cached: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="TestAwsCaching", args={
            "input": input,"not_cached": not_cached,
        })
        return baml_py.BamlStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def TestAwsCaching(self, input: str,not_cached: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestAwsCaching", args={
            "input": input,"not_cached": not_cached,
        }, mode="request")
        return __result__
    async def TestAwsClaude37(self, input: str,
