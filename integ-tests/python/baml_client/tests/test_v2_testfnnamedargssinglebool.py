...
from ..baml_types import IV2_TestFnNamedArgsSingleBool, IV2_TestFnNamedArgsSingleBoolStream
...
async def test_case1(V2_TestFnNamedArgsSingleBoolImpl: IV2_TestFnNamedArgsSingleBoolStream, baml_ipc_channel: BaseIPCChannel):
    ...
    async with V2_TestFnNamedArgsSingleBoolImpl(
        myBool=myBool
    ) as stream:
