...
from ..baml_types import IV2_FnStringOptional, IV2_FnStringOptionalStream
...
async def test_wonderful_black(V2_FnStringOptionalImpl: IV2_FnStringOptionalStream, baml_ipc_channel: BaseIPCChannel):
