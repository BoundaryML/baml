...
from ..baml_types import ITestFnNamedArgsSingleInt, ITestFnNamedArgsSingleIntStream
...
async def test_human_lime(TestFnNamedArgsSingleIntImpl: ITestFnNamedArgsSingleIntStream, baml_ipc_channel: BaseIPCChannel):
