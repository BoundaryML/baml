...
from ..baml_types import IV2_FnOutputStringList, IV2_FnOutputStringListStream
...
async def test_substantial_tan(V2_FnOutputStringListImpl: IV2_FnOutputStringListStream, baml_ipc_channel: BaseIPCChannel):
