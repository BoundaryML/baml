...
from ..baml_types import IFnTestClassOverride, IFnTestClassOverrideStream, OverrideClass
...
async def test_governing_pink(FnTestClassOverrideImpl: IFnTestClassOverrideStream, baml_ipc_channel: BaseIPCChannel):
    ...
    async with FnTestClassOverrideImpl(param) as stream:
