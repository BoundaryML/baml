...
from ..baml_types import IFnClassOptional, IFnClassOptionalStream, OptionalClass
...
async def test_elegant_green(FnClassOptionalImpl: IFnClassOptionalStream, baml_ipc_channel: BaseIPCChannel):
