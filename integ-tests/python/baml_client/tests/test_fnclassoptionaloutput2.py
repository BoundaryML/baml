...
from ..baml_types import Blah, ClassOptionalOutput2, IFnClassOptionalOutput2, IFnClassOptionalOutput2Stream
...
async def test_increasing_crimson(FnClassOptionalOutput2Impl: IFnClassOptionalOutput2Stream, baml_ipc_channel: BaseIPCChannel):
