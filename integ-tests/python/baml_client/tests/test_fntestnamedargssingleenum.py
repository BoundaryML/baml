...
from ..baml_types import IFnTestNamedArgsSingleEnum, IFnTestNamedArgsSingleEnumStream, NamedArgsSingleEnum
...
async def test_case1(FnTestNamedArgsSingleEnumImpl: IFnTestNamedArgsSingleEnumStream, baml_ipc_channel: BaseIPCChannel):
    ...
    async with FnTestNamedArgsSingleEnumImpl(
        myArg=myArg
    ) as stream:
