...
from ..baml_types import ITestFnNamedArgsSingleFloat, ITestFnNamedArgsSingleFloatStream
...
async def test_lost_maroon(TestFnNamedArgsSingleFloatImpl: ITestFnNamedArgsSingleFloatStream, baml_ipc_channel: BaseIPCChannel):
