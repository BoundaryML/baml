...
from ..baml_types import EnumOutput, IV2_FnEnumListOutput, IV2_FnEnumListOutputStream
...
async def test_precise_brown(V2_FnEnumListOutputImpl: IV2_FnEnumListOutputStream, baml_ipc_channel: BaseIPCChannel):
    ...
    async with V2_FnEnumListOutputImpl(
        input=input
    ) as stream:
