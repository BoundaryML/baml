...
from ..baml_types import ClassWithImage, FakeImage, IDescribeImage3, IDescribeImage3Stream
...
async def test_test1(DescribeImage3Impl: IDescribeImage3Stream, baml_ipc_channel: BaseIPCChannel):
