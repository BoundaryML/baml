...
from .functions.fx_describeimage4 import BAMLDescribeImage4
...
class BAMLClient:
    ...
    DescribeImage = BAMLDescribeImage
    DescribeImage2 = BAMLDescribeImage2
    DescribeImage3 = BAMLDescribeImage3
    DescribeImage4 = BAMLDescribeImage4
