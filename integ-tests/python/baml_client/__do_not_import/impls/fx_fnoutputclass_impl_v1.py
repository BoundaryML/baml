...
# Impl: v1
# Client: GPT35
# An implementation of FnOutputClass.
...
__deserializer = Deserializer[TestOutputClass](TestOutputClass)  # type: ignore

# Add a deserializer that handles stream responses, which are all Partial types
__partial_deserializer = Deserializer[PartialTestOutputClass](PartialTestOutputClass)  # type: ignore
...
async def v1(arg: str, /) -> TestOutputClass:
...
def v1_stream(arg: str, /) -> AsyncStream[TestOutputClass, PartialTestOutputClass]:
...
BAMLFnOutputClass.register_impl("v1")(v1, v1_stream)