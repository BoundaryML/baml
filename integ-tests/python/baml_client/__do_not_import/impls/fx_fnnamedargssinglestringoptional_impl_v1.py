...
# Impl: v1
# Client: GPT35
# An implementation of FnNamedArgsSingleStringOptional.
...
async def v1(*, myString: Optional[str] = None) -> str:
...
def v1_stream(*, myString: Optional[str] = None
) -> AsyncStream[str, str]:
...
BAMLFnNamedArgsSingleStringOptional.register_impl("v1")(v1, v1_stream)