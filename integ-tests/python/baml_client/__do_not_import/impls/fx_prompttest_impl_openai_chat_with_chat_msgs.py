...
import typing
# Impl: openai_chat_with_chat_msgs
# Client: GPT35
...
async def openai_chat_with_chat_msgs(arg: str, /) -> str:
    response = await GPT35.run_chat_template(__prompt_template, replacers=__input_replacers, params=dict(arg=arg))
    deserialized = __deserializer.from_string(response.generated)
    return deserialized


def openai_chat_with_chat_msgs_stream(arg: str, /) -> AsyncStream[str, str]:
    def run_prompt() -> typing.AsyncIterator[LLMResponse]:
        raw_stream = GPT35.run_chat_template_stream(__prompt_template, replacers=__input_replacers, params=dict(arg=arg))
        return raw_stream
    stream = AsyncStream(stream_cb=run_prompt, partial_deserializer=__partial_deserializer, final_deserializer=__deserializer)
    return stream

BAMLPromptTest.register_impl("openai_chat_with_chat_msgs")(openai_chat_with_chat_msgs, openai_chat_with_chat_msgs_stream)