...
# Impl: v1
# Client: GPT35
# An implementation of FnClassOptional2.
...
async def v1(arg: ClassOptionalFields, /) -> str:
...
def v1_stream(arg: ClassOptionalFields, /) -> AsyncStream[str, str]:
...
BAMLFnClassOptional2.register_impl("v1")(v1, v1_stream)