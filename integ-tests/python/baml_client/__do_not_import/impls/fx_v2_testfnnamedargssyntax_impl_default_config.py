...
# Impl: default_config
# Client: GPT35
# An implementation of V2_TestFnNamedArgsSyntax.
...
async def default_config(*, var: str, var_with_underscores: str) -> str:
    response = await GPT35.run_jinja_template(
        ...
        args=dict(var=var, var_with_underscores=var_with_underscores)
    )
    deserialized = __deserializer.from_string(response.generated)
    return deserialized


def default_config_stream(*, var: str, var_with_underscores: str
) -> AsyncStream[str, str]:
...
BAMLV2_TestFnNamedArgsSyntax.register_impl("default_config")(default_config, default_config_stream)