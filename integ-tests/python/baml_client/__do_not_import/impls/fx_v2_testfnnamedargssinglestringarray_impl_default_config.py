...
# Impl: default_config
# Client: GPT35
# An implementation of V2_TestFnNamedArgsSingleStringArray.
...
async def default_config(*, myStringArray: List[str]) -> str:
    response = await GPT35.run_jinja_template(
        ...
        args=dict(myStringArray=myStringArray)
    )
    deserialized = __deserializer.from_string(response.generated)
    return deserialized


def default_config_stream(*, myStringArray: List[str]
) -> AsyncStream[str, str]:
...
BAMLV2_TestFnNamedArgsSingleStringArray.register_impl("default_config")(default_config, default_config_stream)