...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnTestNamedArgsSingleEnum.
...
async def default_config(*, myArg: NamedArgsSingleEnum2) -> str:
...
def default_config_stream(*, myArg: NamedArgsSingleEnum2
) -> AsyncStream[str, str]:
...
BAMLV2_FnTestNamedArgsSingleEnum.register_impl("default_config")(default_config, default_config_stream)