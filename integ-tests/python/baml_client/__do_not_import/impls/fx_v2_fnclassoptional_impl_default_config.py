...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnClassOptional.
...
async def default_config(*, input: Optional[OptionalClassv2] = None) -> str:
...
def default_config_stream(*, input: Optional[OptionalClassv2] = None
) -> AsyncStream[str, str]:
...
BAMLV2_FnClassOptional.register_impl("default_config")(default_config, default_config_stream)