...
# Impl: default_config
# Client: GPT35
# An implementation of V2_FnClassOptional2.
...
async def default_config(*, input: ClassOptionalFieldsv2) -> str:
...
def default_config_stream(*, input: ClassOptionalFieldsv2
) -> AsyncStream[str, str]:
...
BAMLV2_FnClassOptional2.register_impl("default_config")(default_config, default_config_stream)