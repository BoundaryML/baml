...
# Impl: v1
# Client: GPT35
# An implementation of FnOutputStringList.
...
def v1_stream(arg: str, /) -> AsyncStream[List[str], List[str]]:
...
BAMLFnOutputStringList.register_impl("v1")(v1, v1_stream)