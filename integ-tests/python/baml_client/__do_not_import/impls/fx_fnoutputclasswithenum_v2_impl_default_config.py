...
# Impl: default_config
# Client: GPT35
# An implementation of FnOutputClassWithEnum_V2.
...
__deserializer = Deserializer[TestClassWithEnum2](TestClassWithEnum2)  # type: ignore

# Add a deserializer that handles stream responses, which are all Partial types
__partial_deserializer = Deserializer[PartialTestClassWithEnum2](PartialTestClassWithEnum2)  # type: ignore
...
async def default_config(*, input: str) -> TestClassWithEnum2:
...
BAMLFnOutputClassWithEnum_V2.register_impl("default_config")(default_config, default_config_stream)