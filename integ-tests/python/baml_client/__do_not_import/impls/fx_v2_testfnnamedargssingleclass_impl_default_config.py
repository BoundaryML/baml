...
# Impl: default_config
# Client: GPT35
# An implementation of V2_TestFnNamedArgsSingleClass.
...
async def default_config(*, myArg: NamedArgsSingleClass2) -> str:
...
def default_config_stream(*, myArg: NamedArgsSingleClass2
) -> AsyncStream[str, str]:
...
BAMLV2_TestFnNamedArgsSingleClass.register_impl("default_config")(default_config, default_config_stream)