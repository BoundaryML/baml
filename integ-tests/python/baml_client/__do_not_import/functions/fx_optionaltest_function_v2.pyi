...
class IOptionalTest_Function_V2Stream(Protocol):
    ...
    def __call__(self, *, input: str
        ...
        ...
class BAMLOptionalTest_Function_V2Impl:
    async def run(self, *, input: str) -> List[Optional[OptionalTest_ReturnTypev2]]:
        ...
...
class IBAMLOptionalTest_Function_V2:
    def register_impl(
        self, name: ImplName
    ) -> typing.Callable[[IOptionalTest_Function_V2, IOptionalTest_Function_V2Stream], None]:
        ...
    ...
    def get_impl(self, name: ImplName) -> BAMLOptionalTest_Function_V2Impl:
        ...

    @contextmanager
    def mock(self) -> typing.Generator[mock.AsyncMock, None, None]:
        """
        Utility for mocking the OptionalTest_Function_V2Interface.
        ...
        Usage:
            ...
            async def test_logic() -> None:
                with baml.OptionalTest_Function_V2.mock() as mocked:
                    mocked.return_value = ...
                    result = await OptionalTest_Function_V2Impl(...)
    ...
    def test(self, test_function: T) -> T:
        ...
        the OptionalTest_Function_V2Interface.
        ...
        Usage:
            ...
            @baml.OptionalTest_Function_V2.test
            async def test_logic(OptionalTest_Function_V2Impl: IOptionalTest_Function_V2) -> None:
                result = await OptionalTest_Function_V2Impl(...)
            ```
        """
        ...
    ...
    def test(self, *, exclude_impl: typing.Iterable[ImplName] = [], stream: bool = False) -> pytest.MarkDecorator:
        ...
        Usage:
            ...
            @baml.OptionalTest_Function_V2.test(exclude_impl=["implname"])
            async def test_logic(OptionalTest_Function_V2Impl: IOptionalTest_Function_V2) -> None:
                result = await OptionalTest_Function_V2Impl(...)
            ```
            ...
            @baml.OptionalTest_Function_V2.test(stream=True)
            async def test_logic(OptionalTest_Function_V2Impl: IOptionalTest_Function_V2Stream) -> None:
                async for result in OptionalTest_Function_V2Impl(...):
                    ...
            ```
        """
        ...
    ...
    def test(self, test_class: typing.Type[CLS]) -> typing.Type[CLS]:
        ...
        @baml.OptionalTest_Function_V2.test
        class TestClass:
            def test_a(self, OptionalTest_Function_V2Impl: IOptionalTest_Function_V2) -> None:
                ...
            def test_b(self, OptionalTest_Function_V2Impl: IOptionalTest_Function_V2) -> None:
                ...
        ```
        """
        ...
